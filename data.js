...
const ENEMIES = {
  ...
  oni: { id: "oni", ja: "鬼", image: "assets/enemies/oni.png", hp: 144, atk: 30, def: 15, spd: 9, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "鬼の金棒", mult: 1.4 } },
  karasu_tengu: { id: "karasu_tengu", ja: "烏天狗", image: "assets/enemies/karasu_tengu.png", hp: 119, atk: 30, def: 15, spd: 14, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67, isFlying: true,
    bigAttack: { name: "扇の突風", mult: 0.3, aoe: true, debuff: { type: "stun", chance: 0.9, turns: 1 } } },
  yamauba2: { id: "yamauba2", ja: "山姥", image: "assets/enemies/yamauba2.png", hp: 139, atk: 27, def: 15, spd: 8, goldMin: 23, goldMax: 35, xp: 41, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "命喰らいの呪い", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } } },
  gyuki: { id: "gyuki", ja: "牛鬼", image: "assets/enemies/gyuki.png", hp: 173, atk: 33, def: 15, spd: 7, goldMin: 28, goldMax: 40, xp: 46, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "牛鬼の角", mult: 1, debuff: { type: "poison", chance: 0.5, value: 4 } } },
  nue: { id: "nue", ja: "ぬえ", image: "assets/enemies/nue.png", hp: 129, atk: 30, def: 15, spd: 11, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67, isFlying: true,
    bigAttack: { name: "鵺の鳴き声", mult: 1.15, debuff: { type: "silence", chance: 0.4, turns: 2 } } },
  wanyudo: { id: "wanyudo", ja: "輪入道", image: "assets/enemies/wanyudo.png", hp: 124, atk: 30, def: 15, spd: 13, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "火輪の相貌", mult: 1.2, debuff: { type: "stun", chance: 0.35, turns: 1 } } },
  gaikotsu_musha: { id: "gaikotsu_musha", ja: "骸骨武者", image: "assets/enemies/gaikotsu_musha.png", hp: 134, atk: 30, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "骸骨の乱撃", mult: 1.3, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  orochi: { id: "orochi", ja: "大蛇", image: "assets/enemies/orochi.png", hp: 154, atk: 30, def: 15, spd: 9, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "大蛇の毒吐き", mult: 1.15, debuff: { type: "poison", chance: 0.6, value: 4 } } },
  gashadokuro: { id: "gashadokuro", ja: "がしゃどくろ", image: "assets/enemies/gashadokuro.png", hp: 562, atk: 30, def: 35, spd: 9, goldMin: 90, goldMax: 130, xp: 150, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "がしゃどくろの哭き", mult: 1.6, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  kyubi_no_kitsune: { id: "kyubi_no_kitsune", ja: "九尾の狐", image: "assets/enemies/kyubi_no_kitsune.png", hp: 513, atk: 32, def: 35, spd: 12, goldMin: 95, goldMax: 135, xp: 155, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "九尾の妖火", mult: 1.5, debuff: { type: "dmgTakenUp", chance: 0.5, value: 0.2, turns: 3 } } },
  shuten_doji: { id: "shuten_doji", ja: "酒呑童子", image: "assets/enemies/shuten_doji.png", hp: 169, atk: 31, def: 15, spd: 10, goldMin: 40, goldMax: 58, xp: 75, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鬼哭の咆哮", mult: 1.5, debuff: { type: "atkDown", chance: 0.5, value: 0.25, turns: 3 } } },
  ibaraki_doji: { id: "ibaraki_doji", ja: "茨木童子", image: "assets/enemies/ibaraki_doji.png", hp: 179, atk: 33, def: 15, spd: 10, goldMin: 42, goldMax: 60, xp: 78, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鉤爪の一薙ぎ", mult: 1.4, debuff: { type: "defDown", chance: 0.55, value: 0.25, turns: 3 } } },
  dai_tengu: { id: "dai_tengu", ja: "大天狗", image: "assets/enemies/dai_tengu.png", hp: 156, atk: 33, def: 15, spd: 15, goldMin: 41, goldMax: 59, xp: 76, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "扇の突風", mult: 0.3, aoe: true, debuff: { type: "stun", chance: 0.9, turns: 1 } } },
  yamata_no_orochi: { id: "yamata_no_orochi", ja: "八岐大蛇", image: "assets/enemies/yamata_no_orochi.png", hp: 201, atk: 35, def: 15, spd: 8, goldMin: 45, goldMax: 64, xp: 82, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "八岐の乱牙", mult: 1.3, debuff: { type: "poison", chance: 0.65, value: 5 } } },
  tamamo_no_mae: { id: "tamamo_no_mae", ja: "玉藻前", image: "assets/enemies/tamamo_no_mae.png", hp: 150, atk: 33, def: 15, spd: 12, goldMin: 42, goldMax: 60, xp: 77, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "傾国の艶", mult: 1.2, debuff: { type: "atkDown", chance: 0.55, value: 0.3, turns: 3 } } },
  giou: { id: "giou", ja: "鵺王", image: "assets/enemies/giou.png", hp: 183, atk: 33, def: 15, spd: 11, goldMin: 44, goldMax: 62, xp: 80, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鵺王の咆哮", mult: 1.3, debuff: { type: "silence", chance: 0.5, turns: 2 } } },
  kyubi_shin: { id: "kyubi_shin", ja: "九尾の狐(真)", image: "assets/enemies/kyubi_shin.png", hp: 174, atk: 35, def: 15, spd: 13, goldMin: 46, goldMax: 65, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "業炎の九尾", mult: 1.4, debuff: { type: "burn", chance: 0.6, turnsMin: 2, turnsMax: 3 } } },
  gashadokuro_shin: { id: "gashadokuro_shin", ja: "がしゃどくろ(真)", image: "assets/enemies/gashadokuro_shin.png", hp: 220, atk: 33, def: 15, spd: 8, goldMin: 47, goldMax: 66, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "亡骨の大哭", mult: 1.7, debuff: { type: "stun", chance: 0.55, turns: 1 } } },
  yomi_no_onryo: { id: "yomi_no_onryo", ja: "黄泉の怨霊", image: "assets/enemies/yomi_no_onryo.png", hp: 161, atk: 39, def: 15, spd: 11, goldMin: 48, goldMax: 68, xp: 88, minFloor: 56, maxFloor: 1498,
  ...
  karakasa: { id: "karakasa", ja: "からかさ", image: "assets/enemies/karakasa.png", hp: 74, atk: 15, def: 10, spd: 6, goldMin: 13, goldMax: 18, xp: 19, minFloor: 35, maxFloor: 67, isSwarm: true,
    bigAttack: { name: "からかさ跳ね", mult: 0.95, debuff: { type: "spdDown", chance: 0.4, value: 0.2, turns: 3 } } },
  kogitsune: { id: "kogitsune", ja: "こぎつね", image: "assets/enemies/kogitsune.png", hp: 61, atk: 15, def: 10, spd: 13, goldMin: 13, goldMax: 18, xp: 20, minFloor: 35, maxFloor: 67, isSwarm: true,
    bigAttack: { name: "子狐の妖術", mult: 0.95, debuff: { type: "atkDown", chance: 0.4, value: 0.15, turns: 3 } } },
  warashibe_ningyo: { id: "warashibe_ningyo", ja: "わらしべ人形", image: "assets/enemies/warashibe_ningyo.png", hp: 94, atk: 16, def: 10, spd: 5, goldMin: 22, goldMax: 28, xp: 35, minFloor: 56, maxFloor: 1498, isSwarm: true,
    bigAttack: { name: "藁人形の呪い", mult: 1.1, debuff: { type: "atkDown", chance: 0.4, value: 0.2, turns: 3 } } },
  medama_kozou: { id: "medama_kozou", ja: "目玉こぞう", image: "assets/enemies/medama_kozou.png", hp: 80, atk: 18, def: 10, spd: 6, goldMin: 22, goldMax: 30, xp: 36, minFloor: 56, maxFloor: 1498, isSwarm: true,
  ...
  kaizoku_gaikotsu: { id: "kaizoku_gaikotsu", ja: "海賊骸骨", image: "assets/enemies/kaizoku_gaikotsu.png", stage: "coast", hp: 70, atk: 15, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "錆刀の一閃", mult: 1.1, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  iso_inu: { id: "iso_inu", ja: "磯犬", image: "assets/enemies/iso_inu.png", stage: "coast", hp: 62, atk: 17, def: 15, spd: 11, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "潮風の牙", mult: 1.3, debuff: { type: "spdDown", chance: 0.5, value: 0.2, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.3, value: 1 } },
  oo_dako_1: { id: "oo_dako_1", ja: "大ダコ", image: "assets/enemies/oo_dako_1.png", stage: "coast", hp: 83, atk: 15, def: 15, spd: 6, goldMin: 20, goldMax: 30, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "大ダコの締め付け", mult: 1.2, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  iwa_gani: { id: "iwa_gani", ja: "岩ガニ", image: "assets/enemies/iwa_gani.png", stage: "coast", hp: 70, atk: 15, def: 15, spd: 5, goldMin: 19, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "岩鋏", mult: 1.4 },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  gyojin: { id: "gyojin", ja: "魚人", image: "assets/enemies/gyojin.png", stage: "coast", hp: 67, atk: 19, def: 15, spd: 9, goldMin: 20, goldMax: 31, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "三叉槍突き", mult: 1.1, debuff: { type: "bleed", chance: 0.45, value: 2 } } },
  shell_slime: { id: "shell_slime", ja: "シェルスライム", image: "assets/enemies/shell_slime.png", stage: "coast", hp: 74, atk: 13, def: 15, spd: 4, goldMin: 19, goldMax: 29, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "溶蝕の粘液", mult: 1, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  kaisou_no_sei: { id: "kaisou_no_sei", ja: "海藻の精", image: "assets/enemies/kaisou_no_sei.png", stage: "coast", hp: 60, atk: 15, def: 15, spd: 7, goldMin: 18, goldMax: 28, xp: 24, minFloor: 13, maxFloor: 43, isPlant: true,
  ...
  same: { id: "same", ja: "鮫", image: "assets/enemies/same.png", stage: "coast", hp: 65, atk: 19, def: 15, spd: 13, goldMin: 21, goldMax: 32, xp: 27, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "鮫の乱牙", mult: 1.3, debuff: { type: "bleed", chance: 0.6, value: 2 } } },
  iso_onna_1: { id: "iso_onna_1", ja: "磯女", image: "assets/enemies/iso_onna_1.png", stage: "coast", hp: 58, atk: 19, def: 15, spd: 8, goldMin: 20, goldMax: 31, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "黒髪縛り", mult: 1.1, debuff: { type: "spdDown", chance: 0.5, value: 0.25, turns: 3 } } },
  oo_kai: { id: "oo_kai", ja: "大貝", image: "assets/enemies/oo_kai.png", stage: "coast", hp: 79, atk: 15, def: 15, spd: 3, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "大貝の圧殺", mult: 1.4 },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  umibouzu: { id: "umibouzu", ja: "海坊主", image: "assets/enemies/umibouzu.png", stage: "coast", hp: 118, atk: 20, def: 15, spd: 6, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海坊主の大波", mult: 0.5, ignoreGuardian: true } },
  iso_onna_2: { id: "iso_onna_2", ja: "磯女", image: "assets/enemies/iso_onna_2.png", stage: "coast", hp: 106, atk: 22, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "怨念の黒髪", mult: 1.2, debuff: { type: "spdDown", chance: 0.55, value: 0.25, turns: 3 } } },
  iwagaki_ou: { id: "iwagaki_ou", ja: "岩ガキ翁", image: "assets/enemies/iwagaki_ou.png", stage: "coast", hp: 114, atk: 18, def: 15, spd: 4, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "老翁の岩殻", mult: 1.3 } },
  umihebi: { id: "umihebi", ja: "海蛇", image: "assets/enemies/umihebi.png", stage: "coast", hp: 98, atk: 22, def: 15, spd: 12, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海蛇の毒牙", mult: 1, debuff: { type: "poison", chance: 0.6, value: 4 } },
    onHitInflict: { type: "poison", chance: 0.35, value: 3 } },
  umigumo: { id: "umigumo", ja: "海蜘蛛", image: "assets/enemies/umigumo.png", stage: "coast", hp: 102, atk: 20, def: 15, spd: 8, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海蜘蛛の縛糸", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  ryuuguu_no_shisha: { id: "ryuuguu_no_shisha", ja: "竜宮の使者", image: "assets/enemies/ryuuguu_no_shisha.png", stage: "coast", hp: 94, atk: 22, def: 15, spd: 13, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "竜宮の穂先", mult: 1.2, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  oo_dako_2: { id: "oo_dako_2", ja: "大ダコ", image: "assets/enemies/oo_dako_2.png", stage: "coast", hp: 122, atk: 20, def: 15, spd: 7, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "岩場の抱擁", mult: 1.2, debuff: { type: "defDown", chance: 0.55, value: 0.25, turns: 3 } } },
  same_bito: { id: "same_bito", ja: "鮫人", image: "assets/enemies/same_bito.png", stage: "coast", hp: 106, atk: 24, def: 15, spd: 12, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "鮫人の乱撃", mult: 1.25, debuff: { type: "bleed", chance: 0.6, value: 2 } },
    onHitInflict: { type: "bleed", chance: 0.25, value: 1 } },
  shinkai_no_bourei: { id: "shinkai_no_bourei", ja: "深海の亡霊", image: "assets/enemies/shinkai_no_bourei.png", stage: "coast", hp: 90, atk: 24, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
  ...
  oo_kani_ou: { id: "oo_kani_ou", ja: "大蟹王", image: "assets/enemies/oo_kani_ou.png", stage: "coast", hp: 546, atk: 32, def: 35, spd: 7, goldMin: 90, goldMax: 130, xp: 150, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "王鋏の一閃", mult: 1.5, debuff: { type: "defDown", chance: 0.4, value: 0.2, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  kaima_daiou: { id: "kaima_daiou", ja: "海魔大王", image: "assets/enemies/kaima_daiou.png", stage: "coast", hp: 141, atk: 27, def: 15, spd: 8, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "大槍薙ぎ", mult: 1.4, ignoreGuardian: true } },
  youen_na_isoonna: { id: "youen_na_isoonna", ja: "妖艶な磯女", image: "assets/enemies/youen_na_isoonna.png", stage: "coast", hp: 126, atk: 25, def: 15, spd: 11, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "魅了の歌声", mult: 1.1, debuff: { type: "atkDown", chance: 0.55, value: 0.25, turns: 3 } } },
  kyokai_no_oodako: { id: "kyokai_no_oodako", ja: "巨海の大ダコ", image: "assets/enemies/kyokai_no_oodako.png", stage: "coast", hp: 156, atk: 25, def: 15, spd: 7, goldMin: 48, goldMax: 68, xp: 87, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "八腕搦め", mult: 1.3, debuff: { type: "stun", chance: 0.35, turns: 1 } } },
  oni_harifugu: { id: "oni_harifugu", ja: "鬼ハリフグ", image: "assets/enemies/oni_harifugu.png", stage: "coast", hp: 131, atk: 25, def: 15, spd: 6, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
  ...
  oo_kani_shougun: { id: "oo_kani_shougun", ja: "大蟹将軍", image: "assets/enemies/oo_kani_shougun.png", stage: "coast", hp: 149, atk: 25, def: 15, spd: 6, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "将軍鋏", mult: 1.5, debuff: { type: "defDown", chance: 0.4, value: 0.25, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  kairyuu_ou: { id: "kairyuu_ou", ja: "海龍王", image: "assets/enemies/kairyuu_ou.png", stage: "coast", hp: 163, atk: 27, def: 15, spd: 10, goldMin: 50, goldMax: 70, xp: 90, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "海龍の雷", mult: 1.3, debuff: { type: "stun", chance: 0.4, turns: 1 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  same_no_bujin: { id: "same_no_bujin", ja: "鮫の武人", image: "assets/enemies/same_no_bujin.png", stage: "coast", hp: 137, atk: 27, def: 15, spd: 13, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "武人の穂先", mult: 1.3, debuff: { type: "bleed", chance: 0.65, value: 2 } },
    onHitInflict: { type: "bleed", chance: 0.3, value: 1 } },
  umi_no_souryo: { id: "umi_no_souryo", ja: "海の僧侶", image: "assets/enemies/umi_no_souryo.png", stage: "coast", hp: 126, atk: 24, def: 15, spd: 9, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "海僧の呪法", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } },
    onHitInflict: { type: "poison", chance: 0.4, value: 3 } },
  uzushio_no_onryou: { id: "uzushio_no_onryou", ja: "渦潮の怨霊", image: "assets/enemies/uzushio_no_onryou.png", stage: "coast", hp: 134, atk: 25, def: 15, spd: 9, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
  ...
  kagegui_sakazuki: { id: "kagegui_sakazuki", ja: "鏡喰い・逆月", image: "assets/enemies/kagegui_sakazuki.png", hp: 400, atk: 22, def: 24, spd: 10, goldMin: 60, goldMax: 90, xp: 90, minFloor: 1, maxFloor: 0, isBoss: true, questOnly: true,
    ...
    // 回想v2(2026-07-31、Codex差し替え)。表現方針=悲哀ではなく腐敗の体験。被害者12人の一覧列挙をやめ、
    // 屋根をただで直した炭焼き藤兵衛1人に集約。中国風の大型装飾鏡→桐の和鏡へ美術も修正
    // gates[文idx]=その文の後のタップ受付待ちms(演出指示書の「間」)、fadeMs[文idx]=その文のフェード時間の上書き
    soulStory: {
      soulLine: "私は三度、代価を告げた。あの女は三度、笑って頷いた。",
      scenes: [
        { image: "assets/story/kagegui_sakazuki_1.jpg",
          text: "初めて見た夜、あの女は自分の膳を旅の親子に差し出した。鍋の底は、もう空だった。『うちは貧しくても、人を飢えさせる宿じゃない』――あの声を、私は覚えている。",
          gates: { 1: 800 } }, // お咲の台詞の前で0.8秒止める
        { image: "assets/story/kagegui_sakazuki_2.jpg",
          text: "だから私は、空の客間を満たす方法を見せた。代価は、満月ごとに影ひとつ。死にはしない。朝には歩いて帰れる――私は三度そう告げた。あの女が三度たしかめたのは、客の命ではなく、自分が罪人になるかどうかだった。",
          gates: { 3: 1000 }, fadeMs: { 4: 900 } }, // 「三度そう告げた。」の後1秒+最終文はゆっくり出す
        { image: "assets/story/kagegui_sakazuki_3.jpg",
          text: "最初の名は、倒れた屋根をただで直した炭焼きの藤兵衛だった。影を失ったあの男が『寒い』と戸を叩いても、女は閂を外さなかった。戸の向こうで夜が明けるまで、私は藤兵衛の名を数え続けた。",
          gates: { 1: 1500 } }, // 「閂を外さなかった。」の後1.5秒
        { image: "assets/story/kagegui_sakazuki_4.jpg",
          text: "十二人目の朝、あの女は私を呪いと呼んだ。次に宿帳へ書いたのは、お前たちの名だった。お前たちを食わせ、私を砕き、銭だけ持って消えるつもりだった。――あの女が恐れたのは妖怪ではない。自分のしたことを、誰かに覚えられることだった。",
          gates: { 1: 1200 } }, // 「お前たちの名だった。」の後1.2秒
      ],
    } },
};
...
// 討伐に行く」モンハン形式になる(2026-07-30ユーザー確定):
//   ・受注はいつでも可。受注後も村・通常探索(深淵の森)は自由に使える
//   ・出発は依頼ごとの出発可能時間(QUEST_DEFS側のdepartStart/departEnd、"11:00"形式)内のみ。
//     時間外に出発ボタンを押すと「◯時まで時間を進めますか？」の確認から時計を送って出発する
//   ・期限なしの一発勝負。討伐成功=報酬+契約金返還(即時)、撤退/全滅=失敗で契約金没収、
//     当日は再受注不可・翌日必ず再張り出し。出発前の取りやめだけは契約金が返還される
//   ・ルート中は一本道(進路選択なし)。依頼側のtargetFloorは「ルート内の層数」として扱う
// このオブジェクトのスキーマ:
//   ja: ルート名(出発ボタン・探索画面の地名に出る。例「沼地」) / emoji: 添える絵文字
//   totalFloors: ルートの全長(この層より先は行き止まり)
