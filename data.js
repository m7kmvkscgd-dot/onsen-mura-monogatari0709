...
// ============ 戦闘後の平和な掛け合い ============
// DIALOGUE_LINES(性格単体のセリフ)とは完全に別管理。性格2人の組み合わせごとに短い2行の
// 掛け合い(A/B)を持たせたデータ。今後追加する野営会話/ボス前会話/帰還時会話/温泉会話も
// 同じ{id, pA, pB, lineA, lineB}構造の配列を増やすだけで対応できるようにしてある。
// pA/pBはセリフ集ファイルの表記順そのまま(片方が言うのがlineA、もう片方がlineB)。
// 実際にどちらのキャラがlineA/lineBを言うかは、選ばれた2人の性格とpA/pBを突き合わせて決める
// (dungeon.js側のmaybeTriggerPeaceDialogue参照)
const PEACE_DIALOGUES_RAW = [
  { id: "001", pA: "優しい", pB: "優しい", lineA: "今日は順調そうだね。", lineB: "うん。この調子で進めたら嬉しいね。" },
  { id: "002", pA: "優しい", pB: "優しい", lineA: "無理してない？", lineB: "うん。まだ大丈夫だよ。" },
  { id: "003", pA: "優しい", pB: "優しい", lineA: "少し安心したね。", lineB: "うん。この時間も悪くないね。" },
  { id: "004", pA: "優しい", pB: "優しい", lineA: "一緒だと心強いね。", lineB: "私も。すごく安心する。" },
  { id: "005", pA: "優しい", pB: "熱血", lineA: "元気いっぱいだね。", lineB: "もちろん！まだまだ行けるよ！" },
  { id: "006", pA: "優しい", pB: "熱血", lineA: "飛ばしすぎないでね。", lineB: "大丈夫！ちゃんとついていくよ！" },
  { id: "007", pA: "優しい", pB: "熱血", lineA: "調子が良さそうで安心した。", lineB: "この勢いで進もう！" },
  { id: "008", pA: "優しい", pB: "熱血", lineA: "その笑顔、素敵だね。", lineB: "えへへ、今日は気分がいいんだ！" },
  { id: "009", pA: "優しい", pB: "冷静", lineA: "落ち着いてるね。", lineB: "今は良い流れだからね。" },
  { id: "010", pA: "優しい", pB: "冷静", lineA: "安心して進めそうだね。", lineB: "油断しなければ大丈夫。" },
  { id: "011", pA: "優しい", pB: "冷静", lineA: "少し気持ちが楽になったよ。", lineB: "その調子を保とう。" },
  { id: "012", pA: "優しい", pB: "冷静", lineA: "一緒だと安心するね。", lineB: "私も、頼りにしている。" },
  { id: "013", pA: "優しい", pB: "生意気", lineA: "今日は機嫌が良さそうだね。", lineB: "まあね。悪くない感じ。" },
  { id: "014", pA: "優しい", pB: "生意気", lineA: "その調子なら安心かな。", lineB: "心配しすぎなんじゃない？" },
  { id: "015", pA: "優しい", pB: "生意気", lineA: "無理だけはしないでね。", lineB: "あたし、そんなに弱くないよ。" },
  { id: "016", pA: "優しい", pB: "生意気", lineA: "頼りにしてるね。", lineB: "ふふっ、見る目あるじゃん。" },
  { id: "017", pA: "優しい", pB: "のんびり", lineA: "今日は穏やかだね。", lineB: "うん、気持ちよく進めそう。" },
  { id: "018", pA: "優しい", pB: "のんびり", lineA: "焦らなくて大丈夫だよ。", lineB: "うん、自分たちのペースで行こう。" },
  { id: "019", pA: "優しい", pB: "のんびり", lineA: "なんだか心が落ち着くね。", lineB: "こういう時間、好きなんだ。" },
  { id: "020", pA: "優しい", pB: "のんびり", lineA: "一緒にいると安心するね。", lineB: "私も。肩の力が抜けるよ。" },
  { id: "021", pA: "優しい", pB: "真面目", lineA: "落ち着いて進めてるね。", lineB: "はい。この調子を維持しましょう。" },
  { id: "022", pA: "優しい", pB: "真面目", lineA: "無理はしてない？", lineB: "大丈夫です。まだ余裕があります。" },
  { id: "023", pA: "優しい", pB: "真面目", lineA: "今日は安心して歩けるね。", lineB: "油断せず、このまま進みましょう。" },
  { id: "024", pA: "優しい", pB: "真面目", lineA: "一緒だと心強いね。", lineB: "私もです。頼りにしています。" },
  { id: "025", pA: "優しい", pB: "世話好き", lineA: "今日は元気そうだね。", lineB: "あなたもね。安心したよ。" },
  { id: "026", pA: "優しい", pB: "世話好き", lineA: "疲れたら言ってね。", lineB: "うん。でもあなたも無理しないでね。" },
  { id: "027", pA: "優しい", pB: "世話好き", lineA: "こうして歩けると安心するね。", lineB: "何事もなく進めるのが一番だね。" },
  { id: "028", pA: "優しい", pB: "世話好き", lineA: "いつも気にかけてくれてありがとう。", lineB: "気付いたら心配しちゃうんだ。" },
  { id: "029", pA: "優しい", pB: "お調子者", lineA: "今日は楽しそうだね。", lineB: "うん！なんだか気分がいいんだ！" },
  { id: "030", pA: "優しい", pB: "お調子者", lineA: "その笑顔を見ると安心するよ。", lineB: "えへへ、つい楽しくなっちゃって！" },
  { id: "031", pA: "優しい", pB: "お調子者", lineA: "元気を分けてもらってる気がする。", lineB: "じゃあもっと元気になるよ！" },
  { id: "032", pA: "優しい", pB: "お調子者", lineA: "今日はいい日になりそうだね。", lineB: "うん！そんな気がしてきた！" },
  { id: "033", pA: "優しい", pB: "無口", lineA: "今日は落ち着いてるね。", lineB: "……うん。" },
  { id: "034", pA: "優しい", pB: "無口", lineA: "隣にいてくれると安心するよ。", lineB: "……私も。" },
  { id: "035", pA: "優しい", pB: "無口", lineA: "何か話したいことある？", lineB: "……今は、このままでいい。" },
  { id: "036", pA: "優しい", pB: "無口", lineA: "ありがとう。", lineB: "……どういたしまして。" },
  { id: "037", pA: "優しい", pB: "怖がり", lineA: "今日は落ち着いてるね。", lineB: "う、うん…。ちょっと安心した。" },
  { id: "038", pA: "優しい", pB: "怖がり", lineA: "大丈夫。一緒にいるからね。", lineB: "ありがとう…。その言葉で安心できる。" },
  { id: "039", pA: "優しい", pB: "怖がり", lineA: "焦らなくても大丈夫だよ。", lineB: "うん…。ゆっくり進もう。" },
  { id: "040", pA: "優しい", pB: "怖がり", lineA: "今日はいい調子だね。", lineB: "このまま何事もないといいな…。" },
  { id: "041", pA: "熱血", pB: "熱血", lineA: "よし、この調子で行こう！", lineB: "最後まで突っ走るよ！" },
  { id: "042", pA: "熱血", pB: "熱血", lineA: "体が軽いな！", lineB: "今日は負ける気がしない！" },
  { id: "043", pA: "熱血", pB: "熱血", lineA: "いい感じに進めてる！", lineB: "もっと盛り上がってきた！" },
  { id: "044", pA: "熱血", pB: "熱血", lineA: "終わったら美味しいもの食べたいな！", lineB: "賛成！そのためにも頑張ろう！" },
  { id: "045", pA: "熱血", pB: "冷静", lineA: "今日は流れがいいね！", lineB: "うん。この調子を崩さなければ大丈夫。" },
  { id: "046", pA: "熱血", pB: "冷静", lineA: "どんどん進もう！", lineB: "急ぐより、確実に行こう。" },
  { id: "047", pA: "熱血", pB: "冷静", lineA: "なんだか楽しくなってきた！", lineB: "楽しめる余裕があるのは良いことだね。" },
  { id: "048", pA: "熱血", pB: "冷静", lineA: "よーし、このまま最後まで行くよ！", lineB: "ええ。その意気で頑張ろう。" },
  { id: "049", pA: "熱血", pB: "生意気", lineA: "今日は絶好調だね！", lineB: "やっと私に追いついてきた？" },
  { id: "050", pA: "熱血", pB: "生意気", lineA: "その余裕、嫌いじゃないよ！", lineB: "でしょ？見てると面白いし。" },
  { id: "051", pA: "熱血", pB: "生意気", lineA: "一緒なら何でもできそうだ！", lineB: "ふふっ、その自信は悪くないね。" },
  { id: "052", pA: "熱血", pB: "生意気", lineA: "まだまだ頑張れるよ！", lineB: "そのくらい元気じゃないと困るよ。" },
  { id: "053", pA: "熱血", pB: "のんびり", lineA: "今日は気分がいいね！", lineB: "うん。のんびり進めそうだね。" },
  { id: "054", pA: "熱血", pB: "のんびり", lineA: "もっと勢いよく行こう！", lineB: "慌てなくても大丈夫だよ。" },
  { id: "055", pA: "熱血", pB: "のんびり", lineA: "元気が有り余ってるよ！", lineB: "その元気、少し分けてほしいな。" },
  { id: "056", pA: "熱血", pB: "のんびり", lineA: "休まず行けそう！", lineB: "休める時は休んだほうがいいよ。" },
  { id: "057", pA: "熱血", pB: "真面目", lineA: "今日も気合い十分だよ！", lineB: "その意気込みは頼もしいですね。" },
  { id: "058", pA: "熱血", pB: "真面目", lineA: "よし、このまま進もう！", lineB: "はい。一歩ずつ確実に行きましょう。" },
  { id: "059", pA: "熱血", pB: "真面目", lineA: "なんだか調子が出てきた！", lineB: "良い流れですね。維持しましょう。" },
  { id: "060", pA: "熱血", pB: "真面目", lineA: "一緒だと心強いね！", lineB: "私もです。最後まで頑張りましょう。" },
  { id: "061", pA: "熱血", pB: "世話好き", lineA: "今日も元気いっぱいだよ！", lineB: "その元気なら安心だね。" },
  { id: "062", pA: "熱血", pB: "世話好き", lineA: "まだまだ走れるよ！", lineB: "無理だけはしないでね。" },
  { id: "063", pA: "熱血", pB: "世話好き", lineA: "今日は気分が最高！", lineB: "その笑顔を見ると私も嬉しいよ。" },
  { id: "064", pA: "熱血", pB: "世話好き", lineA: "よし、次も頑張ろう！", lineB: "うん。一緒に頑張ろうね。" },
  { id: "065", pA: "熱血", pB: "お調子者", lineA: "今日は最高の日だね！", lineB: "でしょでしょ！そんな気がしてた！" },
  { id: "066", pA: "熱血", pB: "お調子者", lineA: "まだまだ元気だよ！", lineB: "あたしなんて絶好調だよ！" },
  { id: "067", pA: "熱血", pB: "お調子者", lineA: "この調子でどんどん行こう！", lineB: "賛成！楽しまなきゃ損だよ！" },
  { id: "068", pA: "熱血", pB: "お調子者", lineA: "一緒だと気分が上がるね！", lineB: "あたしも！なんかワクワクしてきた！" },
  { id: "069", pA: "熱血", pB: "無口", lineA: "今日はいい感じだね！", lineB: "……悪くない。" },
  { id: "070", pA: "熱血", pB: "無口", lineA: "もっと話そうよ！", lineB: "……必要なら。" },
  { id: "071", pA: "熱血", pB: "無口", lineA: "その一言で十分伝わるね！", lineB: "……そうかも。" },
  { id: "072", pA: "熱血", pB: "無口", lineA: "一緒だと心強いよ！", lineB: "……私も。" },
  { id: "073", pA: "熱血", pB: "怖がり", lineA: "今日はいい調子だね！", lineB: "う、うん…。このままなら嬉しいな。" },
  { id: "074", pA: "熱血", pB: "怖がり", lineA: "大丈夫！私がついてるよ！", lineB: "ありがとう…。少し安心した。" },
  { id: "075", pA: "熱血", pB: "怖がり", lineA: "元気出して行こう！", lineB: "うん…。頑張ってついていくね。" },
  { id: "076", pA: "熱血", pB: "怖がり", lineA: "肩の力抜いていいよ！", lineB: "そうする…。少し緊張しすぎてたかも。" },
  { id: "077", pA: "冷静", pB: "冷静", lineA: "順調だね。", lineB: "うん。この流れを保とう。" },
  { id: "078", pA: "冷静", pB: "冷静", lineA: "焦る必要はなさそうだ。", lineB: "落ち着いて進めば十分だね。" },
  { id: "079", pA: "冷静", pB: "冷静", lineA: "余裕があるね。", lineB: "今のうちに気持ちも整えておこう。" },
  { id: "080", pA: "冷静", pB: "冷静", lineA: "静かな時間だね。", lineB: "こういう時ほど周りを見ておこう。" },
  { id: "081", pA: "冷静", pB: "生意気", lineA: "今日は落ち着いてるね。", lineB: "敵も大したことないしね。" },
  { id: "082", pA: "冷静", pB: "生意気", lineA: "油断はしないように。", lineB: "分かってるって。" },
  { id: "083", pA: "冷静", pB: "生意気", lineA: "余裕があるのはいいことだ。", lineB: "そのくらいじゃないとつまらないでしょ。" },
  { id: "084", pA: "冷静", pB: "生意気", lineA: "調子は悪くなさそうだね。", lineB: "もちろん。今日は気分がいいから。" },
  { id: "085", pA: "冷静", pB: "のんびり", lineA: "今日は落ち着いて進めそうだね。", lineB: "うん。こんな時間は好きだよ。" },
  { id: "086", pA: "冷静", pB: "のんびり", lineA: "焦らなくて済みそうだ。", lineB: "急がなくても大丈夫だね。" },
  { id: "087", pA: "冷静", pB: "のんびり", lineA: "いい流れが続いてるね。", lineB: "このまま穏やかだと嬉しいな。" },
  { id: "088", pA: "冷静", pB: "のんびり", lineA: "気持ちにも余裕があるね。", lineB: "うん。肩の力が抜けるよ。" },
  { id: "089", pA: "冷静", pB: "真面目", lineA: "順調だね。", lineB: "はい。この調子を維持しましょう。" },
  { id: "090", pA: "冷静", pB: "真面目", lineA: "落ち着いて進めているね。", lineB: "慌てず、このまま行きましょう。" },
  { id: "091", pA: "冷静", pB: "真面目", lineA: "いい流れだ。", lineB: "ええ。気を緩めず進みましょう。" },
  { id: "092", pA: "冷静", pB: "真面目", lineA: "安心できる状況だね。", lineB: "はい。この時間も大切にしたいです。" },
  { id: "093", pA: "冷静", pB: "世話好き", lineA: "調子は悪くなさそうだね。", lineB: "うん。安心して見ていられるよ。" },
  { id: "094", pA: "冷静", pB: "世話好き", lineA: "落ち着いて進めているね。", lineB: "無理をする人がいなくてよかった。" },
  { id: "095", pA: "冷静", pB: "世話好き", lineA: "今は穏やかだね。", lineB: "こういう時間が続くといいね。" },
  { id: "096", pA: "冷静", pB: "世話好き", lineA: "安心できる状況だ。", lineB: "その言葉を聞くと私も安心する。" },
  { id: "097", pA: "冷静", pB: "お調子者", lineA: "今日は余裕がありそうだね。", lineB: "いい感じ！この調子で行こう！" },
  { id: "098", pA: "冷静", pB: "お調子者", lineA: "気持ちにも余裕があるね。", lineB: "たまにはこういう日もないとね！" },
  { id: "099", pA: "冷静", pB: "お調子者", lineA: "浮かれすぎないようにね。", lineB: "大丈夫！ちゃんと分かってるよ！" },
  { id: "100", pA: "冷静", pB: "お調子者", lineA: "楽しそうだね。", lineB: "うん！笑ってるほうが元気出るし！" },
  { id: "101", pA: "冷静", pB: "無口", lineA: "今日は静かだね。", lineB: "……嫌いじゃない。" },
  { id: "102", pA: "冷静", pB: "無口", lineA: "落ち着いて進めそうだ。", lineB: "……うん。" },
  { id: "103", pA: "冷静", pB: "無口", lineA: "何か気になることはある？", lineB: "……今はない。" },
  { id: "104", pA: "冷静", pB: "無口", lineA: "一緒だと安心できるね。", lineB: "……私もそう思う。" },
  { id: "105", pA: "冷静", pB: "怖がり", lineA: "落ち着いて進めているね。", lineB: "う、うん…。今は安心できる。" },
  { id: "106", pA: "冷静", pB: "怖がり", lineA: "深呼吸すると楽になるよ。", lineB: "そうだね…。少し落ち着いた。" },
  { id: "107", pA: "冷静", pB: "怖がり", lineA: "今は心配しなくて大丈夫。", lineB: "その言葉、すごく安心する…。" },
  { id: "108", pA: "冷静", pB: "怖がり", lineA: "順調だ。このまま行こう。", lineB: "うん…。その調子なら頑張れそう。" },
  { id: "109", pA: "生意気", pB: "生意気", lineA: "今日は楽勝じゃない？", lineB: "最初からそう思ってたけど。" },
  { id: "110", pA: "生意気", pB: "生意気", lineA: "調子いいと気分もいいね。", lineB: "それ、今さら気付いたの？" },
  { id: "111", pA: "生意気", pB: "生意気", lineA: "今日は私たちの勝ちって感じ。", lineB: "まだ終わってないけどね。" },
  { id: "112", pA: "生意気", pB: "生意気", lineA: "たまには褒めてくれてもいいよ？", lineB: "ふふっ、今日は頑張ってるじゃん。" },
  { id: "113", pA: "生意気", pB: "のんびり", lineA: "今日はずいぶん静かじゃない？", lineB: "たまにはこんな日もいいよ。" },
  { id: "114", pA: "生意気", pB: "のんびり", lineA: "そんなにのんびりしてて平気？", lineB: "焦らなくても大丈夫だよ。" },
  { id: "115", pA: "生意気", pB: "のんびり", lineA: "余裕そうでいいね。", lineB: "うん。気持ちにも余裕があるよ。" },
  { id: "116", pA: "生意気", pB: "のんびり", lineA: "その落ち着き、ちょっと不思議。", lineB: "そうかな？私は好きだけど。" },
  { id: "117", pA: "生意気", pB: "真面目", lineA: "今日は調子いいじゃん。", lineB: "ええ。このまま気を引き締めましょう。" },
  { id: "118", pA: "生意気", pB: "真面目", lineA: "そんなに真面目じゃ疲れるよ？", lineB: "慣れていますから大丈夫です。" },
  { id: "119", pA: "生意気", pB: "真面目", lineA: "たまには肩の力抜きなよ。", lineB: "ありがとうございます。でも今は大丈夫です。" },
  { id: "120", pA: "生意気", pB: "真面目", lineA: "あんたといると退屈しないね。", lineB: "そう言っていただけるなら嬉しいです。" },
  { id: "121", pA: "生意気", pB: "世話好き", lineA: "今日は元気そうじゃん。", lineB: "あなたも調子が良さそうで安心したよ。" },
  { id: "122", pA: "生意気", pB: "世話好き", lineA: "そんなに心配しなくても平気だって。", lineB: "つい気になっちゃうんだ。" },
  { id: "123", pA: "生意気", pB: "世話好き", lineA: "そんな顔してると疲れるよ？", lineB: "あなたが元気なら自然と笑顔になるよ。" },
  { id: "124", pA: "生意気", pB: "世話好き", lineA: "ふふ、今日は悪くない日かも。", lineB: "うん。このまま穏やかだといいね。" },
  { id: "125", pA: "生意気", pB: "お調子者", lineA: "今日は気分いいじゃん。", lineB: "でしょ！朝からそんな気がしてた！" },
  { id: "126", pA: "生意気", pB: "お調子者", lineA: "その元気、うるさいくらい。", lineB: "褒め言葉ってことで！" },
  { id: "127", pA: "生意気", pB: "お調子者", lineA: "あんた見てると飽きないね。", lineB: "それ、結構嬉しいかも！" },
  { id: "128", pA: "生意気", pB: "お調子者", lineA: "今日はあんたにしては悪くないね。", lineB: "今日は？今日はって何さ～！" },
  { id: "129", pA: "生意気", pB: "無口", lineA: "何か喋ったら？", lineB: "……何を？" },
  { id: "130", pA: "生意気", pB: "無口", lineA: "静かすぎない？", lineB: "……落ち着くから。" },
  { id: "131", pA: "生意気", pB: "無口", lineA: "その一言で伝わるの、ずるいよね。", lineB: "……そう？" },
  { id: "132", pA: "生意気", pB: "無口", lineA: "たまには笑いなよ。", lineB: "……ふっ。" },
  { id: "133", pA: "生意気", pB: "怖がり", lineA: "そんなに緊張しなくても平気でしょ？", lineB: "そ、そうなんだけど…。" },
  { id: "134", pA: "生意気", pB: "怖がり", lineA: "今日は大丈夫そうじゃん。", lineB: "うん…。今は少し安心してる。" },
  { id: "135", pA: "生意気", pB: "怖がり", lineA: "困ったらちゃんと言いなよ。", lineB: "ありがとう…。その時はお願いするね。" },
  { id: "136", pA: "生意気", pB: "怖がり", lineA: "意外と頑張るじゃん。", lineB: "えへへ…。ちゃんと見てくれてたんだ。" },
  { id: "137", pA: "のんびり", pB: "のんびり", lineA: "今日は気持ちいいね。", lineB: "うん。この時間、好きだな。" },
  { id: "138", pA: "のんびり", pB: "のんびり", lineA: "急がなくても大丈夫だね。", lineB: "自分たちのペースで行こう。" },
  { id: "139", pA: "のんびり", pB: "のんびり", lineA: "なんだか落ち着くね。", lineB: "こういう時間があると安心するよ。" },
  { id: "140", pA: "のんびり", pB: "のんびり", lineA: "少し休みたくなるね。", lineB: "帰ったらゆっくり休もう。" },
  { id: "141", pA: "のんびり", pB: "真面目", lineA: "今日はいい流れだね。", lineB: "ええ。この調子を保ちましょう。" },
  { id: "142", pA: "のんびり", pB: "真面目", lineA: "急がなくても大丈夫だよ。", lineB: "落ち着いて進むことも大切ですね。" },
  { id: "143", pA: "のんびり", pB: "真面目", lineA: "肩の力を抜いていこう。", lineB: "ありがとうございます。少し気が楽になりました。" },
  { id: "144", pA: "のんびり", pB: "真面目", lineA: "一緒だと安心するね。", lineB: "私もです。穏やかに進めます。" },
  { id: "145", pA: "のんびり", pB: "世話好き", lineA: "今日は穏やかだね。", lineB: "うん。安心して見ていられるよ。" },
  { id: "146", pA: "のんびり", pB: "世話好き", lineA: "無理はしてない？", lineB: "大丈夫。でもあなたも気をつけてね。" },
  { id: "147", pA: "のんびり", pB: "世話好き", lineA: "こういう時間って落ち着くね。", lineB: "慌てなくていいからね。" },
  { id: "148", pA: "のんびり", pB: "世話好き", lineA: "一緒にいると安心するよ。", lineB: "私も。同じ気持ちだよ。" },
  { id: "149", pA: "のんびり", pB: "お調子者", lineA: "今日は気分がいいね。", lineB: "でしょ！なんだか楽しくなってきた！" },
  { id: "150", pA: "のんびり", pB: "お調子者", lineA: "そんなに急がなくてもいいよ。", lineB: "じゃあ楽しみながら行こう！" },
  { id: "151", pA: "のんびり", pB: "お調子者", lineA: "笑ってると落ち着くね。", lineB: "笑顔は大事だからね！" },
  { id: "152", pA: "のんびり", pB: "お調子者", lineA: "今日はいい日になりそう。", lineB: "その予感、あたしもする！" },
  { id: "153", pA: "のんびり", pB: "無口", lineA: "今日は静かだね。", lineB: "……うん。" },
  { id: "154", pA: "のんびり", pB: "無口", lineA: "この空気、落ち着くな。", lineB: "……私も好き。" },
  { id: "155", pA: "のんびり", pB: "無口", lineA: "無理しなくていいからね。", lineB: "……ありがとう。" },
  { id: "156", pA: "のんびり", pB: "無口", lineA: "こうして並んで歩くのもいいね。", lineB: "……悪くない。" },
  { id: "157", pA: "のんびり", pB: "怖がり", lineA: "今日は穏やかだね。", lineB: "うん…。少しほっとしてる。" },
  { id: "158", pA: "のんびり", pB: "怖がり", lineA: "ゆっくり進めば大丈夫。", lineB: "そうだね…。そのほうが安心する。" },
  { id: "159", pA: "のんびり", pB: "怖がり", lineA: "深呼吸すると落ち着くよ。", lineB: "ありがとう…。やってみる。" },
  { id: "160", pA: "のんびり", pB: "怖がり", lineA: "隣にいるから大丈夫。", lineB: "うん…。その言葉、嬉しい。" },
  { id: "161", pA: "真面目", pB: "真面目", lineA: "順調ですね。", lineB: "はい。この調子で進みましょう。" },
  { id: "162", pA: "真面目", pB: "真面目", lineA: "落ち着いて行動できていますね。", lineB: "ええ。今の状態を維持したいです。" },
  { id: "163", pA: "真面目", pB: "真面目", lineA: "気を緩めずに行きましょう。", lineB: "はい。でも少し安心しました。" },
  { id: "164", pA: "真面目", pB: "真面目", lineA: "あなたと一緒だと心強いです。", lineB: "私もです。最後まで頑張りましょう。" },
  { id: "165", pA: "真面目", pB: "世話好き", lineA: "体調は大丈夫ですか？", lineB: "うん。あなたも無理しないでね。" },
  { id: "166", pA: "真面目", pB: "世話好き", lineA: "順調に進めていますね。", lineB: "みんな元気そうで安心したよ。" },
  { id: "167", pA: "真面目", pB: "世話好き", lineA: "この調子を維持しましょう。", lineB: "うん。焦らず行こうね。" },
  { id: "168", pA: "真面目", pB: "世話好き", lineA: "あなたがいると心強いです。", lineB: "私も頼りにしてるよ。" },
  { id: "169", pA: "真面目", pB: "お調子者", lineA: "今日は順調ですね。", lineB: "うん！いい感じだね！" },
  { id: "170", pA: "真面目", pB: "お調子者", lineA: "少し気持ちに余裕が出てきました。", lineB: "笑える時は笑っとこうよ！" },
  { id: "171", pA: "真面目", pB: "お調子者", lineA: "あなたはいつも明るいですね。", lineB: "そのほうが楽しいじゃん！" },
  { id: "172", pA: "真面目", pB: "お調子者", lineA: "その前向きさは見習いたいです。", lineB: "えへへ、照れちゃうな！" },
  { id: "173", pA: "真面目", pB: "無口", lineA: "今日は順調ですね。", lineB: "……うん。" },
  { id: "174", pA: "真面目", pB: "無口", lineA: "落ち着いて進めていますね。", lineB: "……その調子。" },
  { id: "175", pA: "真面目", pB: "無口", lineA: "何か気になることはありますか？", lineB: "……今は大丈夫。" },
  { id: "176", pA: "真面目", pB: "無口", lineA: "あなたがいてくれると安心です。", lineB: "……私も。" },
  { id: "177", pA: "真面目", pB: "怖がり", lineA: "ここまでは順調ですね。", lineB: "うん…。少し安心しました。" },
  { id: "178", pA: "真面目", pB: "怖がり", lineA: "焦らず、このまま行きましょう。", lineB: "はい…。そのほうが落ち着きます。" },
  { id: "179", pA: "真面目", pB: "怖がり", lineA: "無理はしていませんか？", lineB: "大丈夫…。気にかけてくれてありがとう。" },
  { id: "180", pA: "真面目", pB: "怖がり", lineA: "あなたと一緒なら心強いです。", lineB: "私も…。勇気が出ます。" },
  { id: "181", pA: "世話好き", pB: "世話好き", lineA: "疲れてない？", lineB: "うん。あなたこそ大丈夫？" },
  { id: "182", pA: "世話好き", pB: "世話好き", lineA: "今日は安心して進めそうだね。", lineB: "そうだね。このまま行けたらいいな。" },
  { id: "183", pA: "世話好き", pB: "世話好き", lineA: "無理しそうになったら言ってね。", lineB: "ありがとう。あなたもね。" },
  { id: "184", pA: "世話好き", pB: "世話好き", lineA: "元気そうでよかった。", lineB: "あなたの顔を見て安心したよ。" },
  { id: "185", pA: "世話好き", pB: "お調子者", lineA: "今日は元気いっぱいだね。", lineB: "もちろん！絶好調だよ！" },
  { id: "186", pA: "世話好き", pB: "お調子者", lineA: "その笑顔を見ると安心するよ。", lineB: "じゃあもっと笑っとこ！" },
  { id: "187", pA: "世話好き", pB: "お調子者", lineA: "無理だけはしないでね。", lineB: "大丈夫！ちゃんと加減するから！" },
  { id: "188", pA: "世話好き", pB: "お調子者", lineA: "今日も楽しそうだね。", lineB: "楽しいほうが頑張れるもん！" },
  { id: "189", pA: "世話好き", pB: "無口", lineA: "今日は落ち着いてるね。", lineB: "……うん。" },
  { id: "190", pA: "世話好き", pB: "無口", lineA: "疲れたら遠慮なく言ってね。", lineB: "……ありがとう。" },
  { id: "191", pA: "世話好き", pB: "無口", lineA: "あなたが元気そうで安心したよ。", lineB: "……心配かけないようにする。" },
  { id: "192", pA: "世話好き", pB: "無口", lineA: "隣にいてくれると安心するね。", lineB: "……私も。" },
  { id: "193", pA: "世話好き", pB: "怖がり", lineA: "今日は少し安心できてる？", lineB: "うん…。今は大丈夫そう。" },
  { id: "194", pA: "世話好き", pB: "怖がり", lineA: "困ったらすぐ頼ってね。", lineB: "ありがとう…。そうするね。" },
  { id: "195", pA: "世話好き", pB: "怖がり", lineA: "無理はしなくていいからね。", lineB: "うん…。その言葉で落ち着くよ。" },
  { id: "196", pA: "世話好き", pB: "怖がり", lineA: "一緒だから大丈夫だよ。", lineB: "うん…。一人じゃないって安心する。" },
  { id: "197", pA: "お調子者", pB: "お調子者", lineA: "今日はついてる気がする！", lineB: "あたしも！なんかワクワクする！" },
  { id: "198", pA: "お調子者", pB: "お調子者", lineA: "この調子なら楽勝かも！", lineB: "その言葉、好きだなー！" },
  { id: "199", pA: "お調子者", pB: "お調子者", lineA: "帰ったら何しようかな！", lineB: "まずはいっぱい休もー！" },
  { id: "200", pA: "お調子者", pB: "お調子者", lineA: "今日は笑ってばっかりだね！", lineB: "笑える時に笑っとかないとね！" },
  { id: "201", pA: "お調子者", pB: "無口", lineA: "ねぇねぇ、何か話そうよ！", lineB: "……何を？" },
  { id: "202", pA: "お調子者", pB: "無口", lineA: "そんなに静かだと寝ちゃうよ？", lineB: "……寝ない。" },
  { id: "203", pA: "お調子者", pB: "無口", lineA: "一言だけでもいいって！", lineB: "……よろしく。" },
  { id: "204", pA: "お調子者", pB: "無口", lineA: "今ちょっと笑ったでしょ！", lineB: "……気のせい。" },
  { id: "205", pA: "お調子者", pB: "怖がり", lineA: "今日はいいことありそうじゃない？", lineB: "う、うん…。そうだと嬉しいな。" },
  { id: "206", pA: "お調子者", pB: "怖がり", lineA: "そんなに緊張しなくても平気だよ！", lineB: "分かってるんだけど…ついね。" },
  { id: "207", pA: "お調子者", pB: "怖がり", lineA: "笑ってたら怖さも逃げるって！", lineB: "ふふっ…。少しだけね。" },
  { id: "208", pA: "お調子者", pB: "怖がり", lineA: "大丈夫！あたしもいるから！", lineB: "ありがとう…。その言葉、心強い。" },
  { id: "209", pA: "無口", pB: "無口", lineA: "……静かだね。", lineB: "……うん。" },
  { id: "210", pA: "無口", pB: "無口", lineA: "……落ち着く。", lineB: "……私も。" },
  { id: "211", pA: "無口", pB: "無口", lineA: "……調子は？", lineB: "……悪くない。" },
  { id: "212", pA: "無口", pB: "無口", lineA: "……行こうか。", lineB: "……うん。" },
  { id: "213", pA: "無口", pB: "怖がり", lineA: "……大丈夫？", lineB: "うん…。少し緊張してるけど。" },
  { id: "214", pA: "無口", pB: "怖がり", lineA: "……無理しないで。", lineB: "ありがとう…。気をつけるね。" },
  { id: "215", pA: "無口", pB: "怖がり", lineA: "……隣にいる。", lineB: "うん…。安心する。" },
  { id: "216", pA: "無口", pB: "怖がり", lineA: "……落ち着いて。", lineB: "うん…。深呼吸してみる。" },
  { id: "217", pA: "怖がり", pB: "怖がり", lineA: "今日は静かだね…。", lineB: "うん…。このままだといいな。" },
  { id: "218", pA: "怖がり", pB: "怖がり", lineA: "少し落ち着いてきたかも…。", lineB: "私も…。さっきより平気。" },
  { id: "219", pA: "怖がり", pB: "怖がり", lineA: "一緒だと安心するね…。", lineB: "うん…。一人じゃないから。" },
  { id: "220", pA: "怖がり", pB: "怖がり", lineA: "帰ったら、ほっとしそう…。", lineB: "うん…。その時が楽しみ。" },
];
// 性格2つから正規化した組み合わせキーを作る(順序を問わず同じキーになる)
function peacePairKey(p1, p2) {
  return [p1, p2].sort().join("|");
}
const PEACE_DIALOGUES = PEACE_DIALOGUES_RAW.map((e) => Object.assign({ pairKey: peacePairKey(e.pA, e.pB) }, e));
// 正規化キー→該当エントリ配列。同じ組み合わせに複数エントリがあるのでランダム抽選に使う
const PEACE_DIALOGUES_BY_PAIR = {};
PEACE_DIALOGUES.forEach((e) => {
  (PEACE_DIALOGUES_BY_PAIR[e.pairKey] = PEACE_DIALOGUES_BY_PAIR[e.pairKey] || []).push(e);
});
function peaceDialoguesForPair(p1, p2) {
  return PEACE_DIALOGUES_BY_PAIR[peacePairKey(p1, p2)] || [];
}
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    PEACE_DIALOGUES, peacePairKey, peaceDialoguesForPair,
