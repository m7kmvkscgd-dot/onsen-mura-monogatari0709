...
const ENEMIES = {
  ...
  kodama: { id: "kodama", ja: "木霊", image: "assets/enemies/kodama.png", hp: 50, atk: 12, def: 25, spd: 5, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18, isPlant: true,
  ...
  cave_tsuchigumo: { id: "cave_tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", stage: "cave", hp: 66, atk: 15, def: 15, spd: 7, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇網搦め", mult: 1.2, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  cave_oomukade: { id: "cave_oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", stage: "cave", hp: 77, atk: 18, def: 15, spd: 5, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
  ...
  cave_nurarikoumori: { id: "cave_nurarikoumori", ja: "ぬらりこうもり", image: "assets/enemies/nurari_koumori.png", stage: "cave", hp: 30, atk: 10, def: 10, spd: 10, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isFlying: true, isSwarm: true,
    ...
    bigAttackCycle: { avg: 5, variance: 1 },
    onHitInflict: { type: "poison", chance: 0.4, value: 2, stacking: true } },
  doukutsu_shokujinsou: { id: "doukutsu_shokujinsou", ja: "洞窟食人草", image: "assets/enemies/doukutsu_shokujinsou.png", stage: "cave", hp: 69, atk: 13, def: 30, spd: 4, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15, isPlant: true,
    bigAttack: { name: "食人草の丸呑み", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } } },
  doukutsu_chouchinbi: { id: "doukutsu_chouchinbi", ja: "洞窟の提灯火", image: "assets/enemies/doukutsu_chouchinbi.png", stage: "cave", hp: 54, atk: 17, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "提灯火の幻惑", mult: 1, debuff: { type: "silence", chance: 0.7, turns: 2 } } },
  bake_nezumi: { id: "bake_nezumi", ja: "化け鼠", image: "assets/enemies/bake_nezumi.png", stage: "cave", hp: 29, atk: 11, def: 10, spd: 9, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isSwarm: true,
    bigAttack: { name: "鼠の乱噛み", mult: 0.95, debuff: { type: "bleed", chance: 0.5, value: 2 } },
    bigAttackCycle: { avg: 6, variance: 2 } },
  bake_take: { id: "bake_take", ja: "化け茸", image: "assets/enemies/bake_take.png", stage: "cave", hp: 60, atk: 13, def: 15, spd: 4, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15, isPlant: true,
    ...
    statusImmune: ["poison"] },
  doukutsu_bourei: { id: "doukutsu_bourei", ja: "洞窟の亡霊", image: "assets/enemies/doukutsu_bourei.png", stage: "cave", hp: 59, atk: 17, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
...
const SKILL_TREES = {
  samurai: {
    ...
    3: {
      ...
      // 新規スキル。HP20%刻み4段のconditionalModsで表現(HP80/60/40/20%以下でそれぞれ攻撃力×1.1、
      // 全部重なると複利で最大約+46%になる。「1段+10%ずつ」の単純加算+40%とは若干ズレるが許容範囲として実装)
      right: {
