...
const ENEMIES = {
  ...
  oogumo: { id: "oogumo", ja: "大蜘蛛", image: "assets/enemies/oogumo.png", hp: 58, atk: 14, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "糸搦め", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  kodama: { id: "kodama", ja: "木霊", image: "assets/enemies/kodama.png", hp: 51, atk: 12, def: 25, spd: 5, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18, isPlant: true,
  ...
  onibi: { id: "onibi", ja: "鬼火", image: "assets/enemies/onibi.png", hp: 40, atk: 15, def: 15, spd: 7, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
  ...
  oo_inoshishi: { id: "oo_inoshishi", ja: "大猪", image: "assets/enemies/oo_inoshishi.png", hp: 431, atk: 23, def: 35, spd: 3, goldMin: 40, goldMax: 60, xp: 40, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
  ...
  cave_tsuchigumo: { id: "cave_tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", stage: "cave", hp: 70, atk: 15, def: 15, spd: 7, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇網搦め", mult: 1.2, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  cave_oomukade: { id: "cave_oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", stage: "cave", hp: 79, atk: 18, def: 15, spd: 5, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "百足の締め上げ", mult: 1.15, debuff: { type: "defDown", chance: 0.5, value: 0.25, turns: 3 } },
    bigAttackCycle: { avg: 5, variance: 1 } },
  cave_nurarikoumori: { id: "cave_nurarikoumori", ja: "ぬらりこうもり", image: "assets/enemies/nurari_koumori.png", stage: "cave", hp: 30, atk: 10, def: 10, spd: 10, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isFlying: true, isSwarm: true,
    bigAttack: { name: "毒の牙", mult: 0.8, debuff: { type: "poison", chance: 0.75, value: 1, turns: 2, turnsMin: 1, turnsMax: 2 } },
    bigAttackCycle: { avg: 5, variance: 1 },
    onHitInflict: { type: "poison", chance: 0.4, value: 2, stacking: true } },
  doukutsu_shokujinsou: { id: "doukutsu_shokujinsou", ja: "洞窟食人草", image: "assets/enemies/doukutsu_shokujinsou.png", stage: "cave", hp: 70, atk: 13, def: 28, spd: 4, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15, isPlant: true,
    bigAttack: { name: "食人草の丸呑み", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } } },
  doukutsu_chouchinbi: { id: "doukutsu_chouchinbi", ja: "洞窟の提灯火", image: "assets/enemies/doukutsu_chouchinbi.png", stage: "cave", hp: 55, atk: 17, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "提灯火の幻惑", mult: 1, debuff: { type: "silence", chance: 0.4, turns: 2 } } },
  bake_nezumi: { id: "bake_nezumi", ja: "化け鼠", image: "assets/enemies/bake_nezumi.png", stage: "cave", hp: 30, atk: 11, def: 10, spd: 9, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isSwarm: true,
    bigAttack: { name: "鼠の乱噛み", mult: 0.95, debuff: { type: "bleed", chance: 0.5, value: 2 } },
    bigAttackCycle: { avg: 6, variance: 2 } },
  bake_take: { id: "bake_take", ja: "化け茸", image: "assets/enemies/bake_take.png", stage: "cave", hp: 61, atk: 13, def: 15, spd: 4, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15, isPlant: true,
    bigAttack: { name: "胞子撒き", mult: 0.3, aoe: true, debuff: { type: "poison", chance: 1, value: 2, turns: 2, turnsMin: 0 } },
    bigAttackCycle: { avg: 6, variance: 2, instant: true },
    onHitInflict: { type: "poison", chance: 0.35, value: 3 },
    statusImmune: ["poison"] },
  doukutsu_bourei: { id: "doukutsu_bourei", ja: "洞窟の亡霊", image: "assets/enemies/doukutsu_bourei.png", stage: "cave", hp: 60, atk: 17, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "亡霊の怨嗟", mult: 0.3, aoe: true, debuff: { type: "dmgTakenUp", chance: 0.65, value: 0.1, turns: 3 } },
    bigAttackCycle: { avg: 6, variance: 1 } },
  doukutsu_inoshishi: { id: "doukutsu_inoshishi", ja: "洞窟イノシシ", image: "assets/enemies/doukutsu_inoshishi.png", stage: "cave", hp: 85, atk: 20, def: 15, spd: 4, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
...
const ENEMY_WEAKNESS = {
  yaken: { type: "bleed", flavor: "深手を負うと獰猛さを失い、防御が大きく低下する。", effects: ["defDown"] },
  inoshishi: { type: "bleed", flavor: "傷を負うと勢いが鈍り、防御が大きく低下する。", effects: ["defDown"] },
  dokuhebi: { type: "bleed", effects: ["atkDown"], flavor: "傷口から体力を失いやすい。" },
  oogumo: { type: "burn", effects: ["atkDown", "defDown"], flavor: "巣や糸は炎に弱く、激しく燃え広がる。" },
  kodama: { type: "burn", flavor: "依代である木が燃えると、その力を維持できない。" },
  kappa: { type: "poison", flavor: "人に近い身体を持つため、毒がよく効く。" },
  hitotsume_kozo: { type: "poison", flavor: "妖力は体調に左右されやすく、毒で術が乱れる。" },
  bake_danuki: { type: "bleed", flavor: "傷を負うと化ける力が不安定になる。" },
  onibi: { type: "spirit", flavor: "霊力に非常に弱い。" },
  kamaitachi: { type: "bleed", flavor: "傷を負うと俊敏さを失い、防御が大きく低下する。", effects: ["defDown"] },
  ...
  tsuchigumo: { type: "burn", flavor: "巨大な巣は炎で簡単に焼き払われる。" },
  onryo: { type: "spirit", flavor: "実体を持たず、霊力に強く侵される。" },
  oomukade: { type: "burn", flavor: "硬い甲殻を持つが、炎には弱い。" },
