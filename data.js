...
const ENEMIES = {
  yaken: { id: "yaken", ja: "野犬", image: "assets/enemies/yaken.png", hp: 14, atk: 4, def: 15, spd: 6, goldMin: 5, goldMax: 11, xp: 8, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "牙噛み", mult: 1, debuff: { type: "spdDown", chance: 0.45, value: 0.2, turns: 3 } } },
  inoshishi: { id: "inoshishi", ja: "猪", image: "assets/enemies/inoshishi.png", hp: 18, atk: 5, def: 15, spd: 4, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "猪突猛進", mult: 1.62 } },
  dokuhebi: { id: "dokuhebi", ja: "毒蛇", image: "assets/enemies/dokuhebi.png", hp: 13, atk: 5, def: 15, spd: 7, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "毒牙", mult: 0.9, debuff: { type: "poison", chance: 1, value: 3 } },
    onHitInflict: { type: "poison", chance: 0.5, value: 3 } },
  oogumo: { id: "oogumo", ja: "大蜘蛛", image: "assets/enemies/oogumo.png", hp: 17, atk: 5, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "糸搦め", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  kodama: { id: "kodama", ja: "木霊", image: "assets/enemies/kodama.png", hp: 15, atk: 5, def: 15, spd: 5, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18, isPlant: true,
    bigAttack: { name: "精気吸い", mult: 0.9, debuff: { type: "atkDown", chance: 0.5, value: 0.15, turns: 3 } } },
  kappa: { id: "kappa", ja: "河童", image: "assets/enemies/kappa.png", hp: 16, atk: 5, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "河童相撲", mult: 1, debuff: { type: "defDown", chance: 0.5, value: 0.15, turns: 3 } } },
  hitotsume_kozo: { id: "hitotsume_kozo", ja: "一つ目小僧", image: "assets/enemies/hitotsume_kozo.png", hp: 14, atk: 5, def: 15, spd: 8, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "一つ目睨み", mult: 1, debuff: { type: "spdDown", chance: 0.4, value: 0.2, turns: 3 } } },
  bake_danuki: { id: "bake_danuki", ja: "化け狸", image: "assets/enemies/bake_danuki.png", hp: 18, atk: 5, def: 15, spd: 6, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "狸囃子", mult: 0.9, debuff: { type: "silence", chance: 0.45, turns: 2 } } },
  onibi: { id: "onibi", ja: "鬼火", image: "assets/enemies/onibi.png", hp: 12, atk: 5, def: 15, spd: 7, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
  ...
  kamaitachi: { id: "kamaitachi", ja: "かまいたち", image: "assets/enemies/kamaitachi.png", hp: 16, atk: 6, def: 15, spd: 10, goldMin: 11, goldMax: 18, xp: 13, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "疾風斬", mult: 1, debuff: { type: "defDown", chance: 0.55, value: 0.2, turns: 3 } } },
  oo_inoshishi: { id: "oo_inoshishi", ja: "大猪", image: "assets/enemies/oo_inoshishi.png", hp: 126, atk: 8, def: 35, spd: 3, goldMin: 40, goldMax: 60, xp: 40, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "大猪突進", mult: 5.95 } },
  q_arakuma: { id: "q_arakuma", ja: "荒熊", image: "assets/enemies/q_arakuma.png", hp: 39, atk: 7, def: 35, spd: 3, goldMin: 35, goldMax: 55, xp: 42, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "熊爪薙ぎ", mult: 1.3, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  q_daija: { id: "q_daija", ja: "大蛇", image: "assets/enemies/q_daija.png", hp: 22, atk: 8, def: 35, spd: 7, goldMin: 35, goldMax: 55, xp: 42, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "鎌首の一閃", mult: 1.2 },
    onHitInflict: { type: "poison", chance: 0.4, value: 4 } },
  q_oni: { id: "q_oni", ja: "鬼", image: "assets/enemies/q_oni.png", hp: 270, atk: 9, def: 35, spd: 4, goldMin: 38, goldMax: 58, xp: 45, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "金棒一閃", mult: 1.4 } },
  q_gashadokuro: { id: "q_gashadokuro", ja: "がしゃどくろ", image: "assets/enemies/q_gashadokuro.png", hp: 144, atk: 8, def: 35, spd: 8, goldMin: 38, goldMax: 58, xp: 45, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "骨鳴らし", mult: 1, debuff: { type: "stun", chance: 0.4, turns: 1 } } },
  ochimusha: { id: "ochimusha", ja: "落武者", image: "assets/enemies/ochimusha.png", hp: 34, atk: 7, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "怨念の一閃", mult: 1.1, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  kamaitachi2: { id: "kamaitachi2", ja: "かまいたち", image: "assets/enemies/kamaitachi2.png", hp: 28, atk: 8, def: 15, spd: 12, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "剛鎌風", mult: 1.15, debuff: { type: "bleed", chance: 0.5, value: 3 } } },
  youko: { id: "youko", ja: "妖狐", image: "assets/enemies/youko.png", hp: 26, atk: 9, def: 15, spd: 9, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "妖狐の幻", mult: 1, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } } },
  rokurokubi: { id: "rokurokubi", ja: "ろくろ首", image: "assets/enemies/rokurokubi.png", hp: 30, atk: 7, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "首伸ばし", mult: 1, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  yukionna: { id: "yukionna", ja: "雪女", image: "assets/enemies/yukionna.png", hp: 27, atk: 8, def: 15, spd: 8, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "氷結の息", mult: 1, debuff: { type: "spdDown", chance: 0.5, value: 0.2, turns: 3 } } },
  yamauba: { id: "yamauba", ja: "山姥", image: "assets/enemies/yamauba.png", hp: 36, atk: 7, def: 15, spd: 6, goldMin: 21, goldMax: 31, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "怪力の一撃", mult: 1.35 } },
  tsuchigumo: { id: "tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", hp: 32, atk: 7, def: 15, spd: 7, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "土蜘蛛の巣", mult: 1.15, debuff: { type: "spdDown", chance: 0.55, value: 0.25, turns: 3 } } },
  onryo: { id: "onryo", ja: "怨霊", image: "assets/enemies/onryo.png", hp: 24, atk: 10, def: 15, spd: 9, goldMin: 21, goldMax: 31, xp: 27, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "怨嗟の声", mult: 0.9, debuff: { type: "dmgTakenUp", chance: 0.45, value: 0.15, turns: 3 } } },
  oomukade: { id: "oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", hp: 38, atk: 8, def: 15, spd: 6, goldMin: 22, goldMax: 33, xp: 27, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "百足の乱噛み", mult: 1, debuff: { type: "poison", chance: 0.6, value: 4 } } },
  kasha: { id: "kasha", ja: "火車", image: "assets/enemies/kasha.png", hp: 34, atk: 9, def: 15, spd: 7, goldMin: 23, goldMax: 35, xp: 29, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "業火の相貌", mult: 1.4, debuff: { type: "atkDown", chance: 0.45, value: 0.2, turns: 3 } } },
  oni: { id: "oni", ja: "鬼", image: "assets/enemies/oni.png", hp: 58, atk: 10, def: 15, spd: 9, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "鬼の金棒", mult: 1.4 } },
  karasu_tengu: { id: "karasu_tengu", ja: "烏天狗", image: "assets/enemies/karasu_tengu.png", hp: 48, atk: 10, def: 15, spd: 14, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67, isFlying: true,
    bigAttack: { name: "扇の突風", mult: 0.3, aoe: true, debuff: { type: "stun", chance: 0.9, turns: 1 } } },
  yamauba2: { id: "yamauba2", ja: "山姥", image: "assets/enemies/yamauba2.png", hp: 56, atk: 9, def: 15, spd: 8, goldMin: 23, goldMax: 35, xp: 41, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "命喰らいの呪い", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } } },
  gyuki: { id: "gyuki", ja: "牛鬼", image: "assets/enemies/gyuki.png", hp: 70, atk: 11, def: 15, spd: 7, goldMin: 28, goldMax: 40, xp: 46, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "牛鬼の角", mult: 1, debuff: { type: "poison", chance: 0.5, value: 4 } } },
  nue: { id: "nue", ja: "ぬえ", image: "assets/enemies/nue.png", hp: 52, atk: 10, def: 15, spd: 11, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67, isFlying: true,
    bigAttack: { name: "鵺の鳴き声", mult: 1.15, debuff: { type: "silence", chance: 0.4, turns: 2 } } },
  wanyudo: { id: "wanyudo", ja: "輪入道", image: "assets/enemies/wanyudo.png", hp: 50, atk: 10, def: 15, spd: 13, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "火輪の相貌", mult: 1.2, debuff: { type: "stun", chance: 0.35, turns: 1 } } },
  gaikotsu_musha: { id: "gaikotsu_musha", ja: "骸骨武者", image: "assets/enemies/gaikotsu_musha.png", hp: 54, atk: 10, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "骸骨の乱撃", mult: 1.3, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  orochi: { id: "orochi", ja: "大蛇", image: "assets/enemies/orochi.png", hp: 62, atk: 10, def: 15, spd: 9, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "大蛇の毒吐き", mult: 1.15, debuff: { type: "poison", chance: 0.6, value: 4 } } },
  gashadokuro: { id: "gashadokuro", ja: "がしゃどくろ", image: "assets/enemies/gashadokuro.png", hp: 170, atk: 14, def: 35, spd: 9, goldMin: 90, goldMax: 130, xp: 150, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "がしゃどくろの哭き", mult: 1.6, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  kyubi_no_kitsune: { id: "kyubi_no_kitsune", ja: "九尾の狐", image: "assets/enemies/kyubi_no_kitsune.png", hp: 155, atk: 15, def: 35, spd: 12, goldMin: 95, goldMax: 135, xp: 155, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "九尾の妖火", mult: 1.5, debuff: { type: "dmgTakenUp", chance: 0.5, value: 0.2, turns: 3 } } },
  shuten_doji: { id: "shuten_doji", ja: "酒呑童子", image: "assets/enemies/shuten_doji.png", hp: 92, atk: 15, def: 15, spd: 10, goldMin: 40, goldMax: 58, xp: 75, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鬼哭の咆哮", mult: 1.5, debuff: { type: "atkDown", chance: 0.5, value: 0.25, turns: 3 } } },
  ibaraki_doji: { id: "ibaraki_doji", ja: "茨木童子", image: "assets/enemies/ibaraki_doji.png", hp: 98, atk: 16, def: 15, spd: 10, goldMin: 42, goldMax: 60, xp: 78, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鉤爪の一薙ぎ", mult: 1.4, debuff: { type: "defDown", chance: 0.55, value: 0.25, turns: 3 } } },
  dai_tengu: { id: "dai_tengu", ja: "大天狗", image: "assets/enemies/dai_tengu.png", hp: 85, atk: 16, def: 15, spd: 15, goldMin: 41, goldMax: 59, xp: 76, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "扇の突風", mult: 0.3, aoe: true, debuff: { type: "stun", chance: 0.9, turns: 1 } } },
  yamata_no_orochi: { id: "yamata_no_orochi", ja: "八岐大蛇", image: "assets/enemies/yamata_no_orochi.png", hp: 110, atk: 17, def: 15, spd: 8, goldMin: 45, goldMax: 64, xp: 82, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "八岐の乱牙", mult: 1.3, debuff: { type: "poison", chance: 0.65, value: 5 } } },
  tamamo_no_mae: { id: "tamamo_no_mae", ja: "玉藻前", image: "assets/enemies/tamamo_no_mae.png", hp: 82, atk: 16, def: 15, spd: 12, goldMin: 42, goldMax: 60, xp: 77, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "傾国の艶", mult: 1.2, debuff: { type: "atkDown", chance: 0.55, value: 0.3, turns: 3 } } },
  giou: { id: "giou", ja: "鵺王", image: "assets/enemies/giou.png", hp: 100, atk: 16, def: 15, spd: 11, goldMin: 44, goldMax: 62, xp: 80, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "鵺王の咆哮", mult: 1.3, debuff: { type: "silence", chance: 0.5, turns: 2 } } },
  kyubi_shin: { id: "kyubi_shin", ja: "九尾の狐(真)", image: "assets/enemies/kyubi_shin.png", hp: 95, atk: 17, def: 15, spd: 13, goldMin: 46, goldMax: 65, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "業炎の九尾", mult: 1.4, debuff: { type: "burn", chance: 0.6, turnsMin: 2, turnsMax: 3 } } },
  gashadokuro_shin: { id: "gashadokuro_shin", ja: "がしゃどくろ(真)", image: "assets/enemies/gashadokuro_shin.png", hp: 120, atk: 16, def: 15, spd: 8, goldMin: 47, goldMax: 66, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "亡骨の大哭", mult: 1.7, debuff: { type: "stun", chance: 0.55, turns: 1 } } },
  yomi_no_onryo: { id: "yomi_no_onryo", ja: "黄泉の怨霊", image: "assets/enemies/yomi_no_onryo.png", hp: 88, atk: 19, def: 15, spd: 11, goldMin: 48, goldMax: 68, xp: 88, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "黄泉の呪詛", mult: 1.3, debuff: { type: "dmgTakenUp", chance: 0.55, value: 0.25, turns: 3 } } },
  kishin_rasetsuo: { id: "kishin_rasetsuo", ja: "鬼神・羅刹王", image: "assets/enemies/kishin_rasetsuo.png", hp: 280, atk: 20, def: 35, spd: 12, goldMin: 220, goldMax: 320, xp: 420, minFloor: 62, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "羅刹の薙ぎ払い", mult: 1.4, ignoreGuardian: true, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  nurari_koumori: { id: "nurari_koumori", ja: "ぬらりこうもり", image: "assets/enemies/nurari_koumori.png", hp: 6, atk: 3, def: 10, spd: 9, goldMin: 3, goldMax: 5, xp: 5, minFloor: 1, maxFloor: 18, isFlying: true, isSwarm: true,
  ...
  chochin_obake: { id: "chochin_obake", ja: "提灯おばけ", image: "assets/enemies/chochin_obake.png", hp: 8, atk: 2, def: 10, spd: 5, goldMin: 3, goldMax: 6, xp: 5, minFloor: 1, maxFloor: 18, isSwarm: true,
    bigAttack: { name: "驚きの灯り", mult: 0.8, debuff: { type: "spdDown", chance: 0.35, value: 0.15, turns: 2 } } },
  kawappa: { id: "kawappa", ja: "かわっぱ", image: "assets/enemies/kawappa.png", hp: 13, atk: 4, def: 10, spd: 6, goldMin: 10, goldMax: 14, xp: 11, minFloor: 13, maxFloor: 43, isSwarm: true,
    bigAttack: { name: "悪戯突き", mult: 0.9, debuff: { type: "defDown", chance: 0.4, value: 0.15, turns: 3 } } },
  chibi_oni: { id: "chibi_oni", ja: "ちび鬼", image: "assets/enemies/chibi_oni.png", hp: 12, atk: 4, def: 10, spd: 7, goldMin: 10, goldMax: 16, xp: 12, minFloor: 13, maxFloor: 43, isSwarm: true,
    bigAttack: { name: "豆鬼の一撃", mult: 1 } },
  karakasa: { id: "karakasa", ja: "からかさ", image: "assets/enemies/karakasa.png", hp: 27, atk: 5, def: 10, spd: 6, goldMin: 13, goldMax: 18, xp: 19, minFloor: 35, maxFloor: 67, isSwarm: true,
    bigAttack: { name: "からかさ跳ね", mult: 0.95, debuff: { type: "spdDown", chance: 0.4, value: 0.2, turns: 3 } } },
  kogitsune: { id: "kogitsune", ja: "こぎつね", image: "assets/enemies/kogitsune.png", hp: 22, atk: 5, def: 10, spd: 13, goldMin: 13, goldMax: 18, xp: 20, minFloor: 35, maxFloor: 67, isSwarm: true,
    bigAttack: { name: "子狐の妖術", mult: 0.95, debuff: { type: "atkDown", chance: 0.4, value: 0.15, turns: 3 } } },
  warashibe_ningyo: { id: "warashibe_ningyo", ja: "わらしべ人形", image: "assets/enemies/warashibe_ningyo.png", hp: 47, atk: 7, def: 10, spd: 5, goldMin: 22, goldMax: 28, xp: 35, minFloor: 56, maxFloor: 1498, isSwarm: true,
    bigAttack: { name: "藁人形の呪い", mult: 1.1, debuff: { type: "atkDown", chance: 0.4, value: 0.2, turns: 3 } } },
  medama_kozou: { id: "medama_kozou", ja: "目玉こぞう", image: "assets/enemies/medama_kozou.png", hp: 40, atk: 8, def: 10, spd: 6, goldMin: 22, goldMax: 30, xp: 36, minFloor: 56, maxFloor: 1498, isSwarm: true,
    bigAttack: { name: "百目睨み", mult: 1.1, debuff: { type: "spdDown", chance: 0.45, value: 0.2, turns: 3 } } },
  cave_tsuchigumo: { id: "cave_tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", stage: "cave", hp: 24, atk: 7, def: 15, spd: 7, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇網搦め", mult: 1.2, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  cave_oomukade: { id: "cave_oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", stage: "cave", hp: 26, atk: 7, def: 15, spd: 6, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "百足の締め上げ", mult: 1.15, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  cave_oogumo: { id: "cave_oogumo", ja: "大蜘蛛", image: "assets/enemies/oogumo.png", stage: "cave", hp: 20, atk: 6, def: 15, spd: 7, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇の巣網", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  cave_nurarikoumori: { id: "cave_nurarikoumori", ja: "ぬらりこうもり", image: "assets/enemies/nurari_koumori.png", stage: "cave", hp: 8, atk: 4, def: 10, spd: 10, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isFlying: true, isSwarm: true,
    bigAttack: { name: "金切りの乱舞", mult: 0.85, debuff: { type: "spdDown", chance: 0.35, value: 0.15, turns: 2 } },
    onHitInflict: { type: "poison", chance: 0.4, value: 2, stacking: true } },
  cave_onibi: { id: "cave_onibi", ja: "鬼火", image: "assets/enemies/onibi.png", stage: "cave", hp: 16, atk: 6, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "纏わり火", mult: 1.1, debuff: { type: "burn", chance: 0.6, turnsMin: 2, turnsMax: 3 } },
    onHitInflict: { type: "burn", chance: 0.3, turnsMin: 2, turnsMax: 3 } },
  doukutsu_shokujinsou: { id: "doukutsu_shokujinsou", ja: "洞窟食人草", image: "assets/enemies/doukutsu_shokujinsou.png", stage: "cave", hp: 22, atk: 7, def: 15, spd: 4, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15, isPlant: true,
  ...
  doukutsu_chouchinbi: { id: "doukutsu_chouchinbi", ja: "洞窟の提灯火", image: "assets/enemies/doukutsu_chouchinbi.png", stage: "cave", hp: 18, atk: 6, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "提灯火の幻惑", mult: 1, debuff: { type: "silence", chance: 0.4, turns: 2 } } },
  bake_nezumi: { id: "bake_nezumi", ja: "化け鼠", image: "assets/enemies/bake_nezumi.png", stage: "cave", hp: 9, atk: 4, def: 10, spd: 9, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isSwarm: true,
    bigAttack: { name: "鼠の乱噛み", mult: 0.95, debuff: { type: "bleed", chance: 0.4, value: 2 } } },
  bake_take: { id: "bake_take", ja: "化け茸", image: "assets/enemies/bake_take.png", stage: "cave", hp: 20, atk: 6, def: 15, spd: 4, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15, isPlant: true,
    bigAttack: { name: "胞子撒き", mult: 1.15, debuff: { type: "defDown", chance: 0.45, value: 0.15, turns: 3 } },
    onHitInflict: { type: "poison", chance: 0.35, value: 3 } },
  doukutsu_bourei: { id: "doukutsu_bourei", ja: "洞窟の亡霊", image: "assets/enemies/doukutsu_bourei.png", stage: "cave", hp: 18, atk: 7, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "亡霊の怨嗟", mult: 1.1, debuff: { type: "dmgTakenUp", chance: 0.45, value: 0.15, turns: 3 } } },
  doukutsu_inoshishi: { id: "doukutsu_inoshishi", ja: "洞窟イノシシ", image: "assets/enemies/doukutsu_inoshishi.png", stage: "cave", hp: 26, atk: 7, def: 15, spd: 4, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "洞窟の猛進", mult: 1.5 } },
  iso_gani: { id: "iso_gani", ja: "磯ガニ", image: "assets/enemies/iso_gani.png", stage: "coast", hp: 14, atk: 4, def: 15, spd: 3, goldMin: 5, goldMax: 10, xp: 8, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "大鋏挟み", mult: 1.3, debuff: { type: "atkDown", chance: 0.4, value: 0.15, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  yadokari: { id: "yadokari", ja: "ヤドカリ", image: "assets/enemies/yadokari.png", stage: "coast", hp: 16, atk: 4, def: 15, spd: 4, goldMin: 5, goldMax: 11, xp: 8, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "貝殻突撃", mult: 1.2 } },
  isozakana: { id: "isozakana", ja: "磯魚", image: "assets/enemies/isozakana.png", stage: "coast", hp: 7, atk: 2, def: 10, spd: 8, goldMin: 3, goldMax: 6, xp: 5, minFloor: 1, maxFloor: 18, isSwarm: true,
    bigAttack: { name: "跳ね躍り", mult: 1.3 },
    onHitInflict: { type: "bleed", chance: 1, valueMin: 1, valueMax: 2 } },
  kurage_bou: { id: "kurage_bou", ja: "くらげ坊", image: "assets/enemies/kurage_bou.png", stage: "coast", hp: 13, atk: 4, def: 15, spd: 5, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "痺れ触手", mult: 1, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  kaiyose: { id: "kaiyose", ja: "貝寄せ", image: "assets/enemies/kaiyose.png", stage: "coast", hp: 13, atk: 4, def: 15, spd: 3, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "貝閉じの一撃", mult: 1.3 },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  hama_tako: { id: "hama_tako", ja: "浜タコ", image: "assets/enemies/hama_tako.png", stage: "coast", hp: 17, atk: 5, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "足絡め", mult: 1, debuff: { type: "spdDown", chance: 0.5, value: 0.2, turns: 3 } } },
  kaisou_douji: { id: "kaisou_douji", ja: "海藻童子", image: "assets/enemies/kaisou_douji.png", stage: "coast", hp: 14, atk: 5, def: 15, spd: 9, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18, isPlant: true,
    bigAttack: { name: "海藻の鞭", mult: 1.1 } },
  harifugu: { id: "harifugu", ja: "ハリフグ", image: "assets/enemies/harifugu.png", stage: "coast", hp: 15, atk: 6, def: 15, spd: 5, goldMin: 8, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "針膨れ突進", mult: 1.5 } },
  umineko: { id: "umineko", ja: "ウミネコ", image: "assets/enemies/umineko.png", stage: "coast", hp: 13, atk: 5, def: 15, spd: 10, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18, isFlying: true,
    bigAttack: { name: "急降下つつき", mult: 1, debuff: { type: "spdDown", chance: 0.4, value: 0.2, turns: 3 } } },
  kaizoku_gaikotsu: { id: "kaizoku_gaikotsu", ja: "海賊骸骨", image: "assets/enemies/kaizoku_gaikotsu.png", stage: "coast", hp: 30, atk: 8, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "錆刀の一閃", mult: 1.1, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  iso_inu: { id: "iso_inu", ja: "磯犬", image: "assets/enemies/iso_inu.png", stage: "coast", hp: 27, atk: 9, def: 15, spd: 11, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "潮風の牙", mult: 1.3, debuff: { type: "spdDown", chance: 0.5, value: 0.2, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.3, value: 1 } },
  oo_dako_1: { id: "oo_dako_1", ja: "大ダコ", image: "assets/enemies/oo_dako_1.png", stage: "coast", hp: 36, atk: 8, def: 15, spd: 6, goldMin: 20, goldMax: 30, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "大ダコの締め付け", mult: 1.2, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  iwa_gani: { id: "iwa_gani", ja: "岩ガニ", image: "assets/enemies/iwa_gani.png", stage: "coast", hp: 30, atk: 8, def: 15, spd: 5, goldMin: 19, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "岩鋏", mult: 1.4 },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  gyojin: { id: "gyojin", ja: "魚人", image: "assets/enemies/gyojin.png", stage: "coast", hp: 29, atk: 10, def: 15, spd: 9, goldMin: 20, goldMax: 31, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "三叉槍突き", mult: 1.1, debuff: { type: "bleed", chance: 0.45, value: 2 } } },
  shell_slime: { id: "shell_slime", ja: "シェルスライム", image: "assets/enemies/shell_slime.png", stage: "coast", hp: 32, atk: 7, def: 15, spd: 4, goldMin: 19, goldMax: 29, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "溶蝕の粘液", mult: 1, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  kaisou_no_sei: { id: "kaisou_no_sei", ja: "海藻の精", image: "assets/enemies/kaisou_no_sei.png", stage: "coast", hp: 26, atk: 8, def: 15, spd: 7, goldMin: 18, goldMax: 28, xp: 24, minFloor: 13, maxFloor: 43, isPlant: true,
  ...
  same: { id: "same", ja: "鮫", image: "assets/enemies/same.png", stage: "coast", hp: 28, atk: 10, def: 15, spd: 13, goldMin: 21, goldMax: 32, xp: 27, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "鮫の乱牙", mult: 1.3, debuff: { type: "bleed", chance: 0.6, value: 2 } } },
  iso_onna_1: { id: "iso_onna_1", ja: "磯女", image: "assets/enemies/iso_onna_1.png", stage: "coast", hp: 25, atk: 10, def: 15, spd: 8, goldMin: 20, goldMax: 31, xp: 26, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "黒髪縛り", mult: 1.1, debuff: { type: "spdDown", chance: 0.5, value: 0.25, turns: 3 } } },
  oo_kai: { id: "oo_kai", ja: "大貝", image: "assets/enemies/oo_kai.png", stage: "coast", hp: 34, atk: 8, def: 15, spd: 3, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "大貝の圧殺", mult: 1.4 },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  umibouzu: { id: "umibouzu", ja: "海坊主", image: "assets/enemies/umibouzu.png", stage: "coast", hp: 60, atk: 10, def: 15, spd: 6, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海坊主の大波", mult: 0.5, ignoreGuardian: true } },
  iso_onna_2: { id: "iso_onna_2", ja: "磯女", image: "assets/enemies/iso_onna_2.png", stage: "coast", hp: 54, atk: 11, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "怨念の黒髪", mult: 1.2, debuff: { type: "spdDown", chance: 0.55, value: 0.25, turns: 3 } } },
  iwagaki_ou: { id: "iwagaki_ou", ja: "岩ガキ翁", image: "assets/enemies/iwagaki_ou.png", stage: "coast", hp: 58, atk: 9, def: 15, spd: 4, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "老翁の岩殻", mult: 1.3 } },
  umihebi: { id: "umihebi", ja: "海蛇", image: "assets/enemies/umihebi.png", stage: "coast", hp: 50, atk: 11, def: 15, spd: 12, goldMin: 25, goldMax: 37, xp: 43, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海蛇の毒牙", mult: 1, debuff: { type: "poison", chance: 0.6, value: 4 } },
    onHitInflict: { type: "poison", chance: 0.35, value: 3 } },
  umigumo: { id: "umigumo", ja: "海蜘蛛", image: "assets/enemies/umigumo.png", stage: "coast", hp: 52, atk: 10, def: 15, spd: 8, goldMin: 24, goldMax: 36, xp: 42, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "海蜘蛛の縛糸", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  ryuuguu_no_shisha: { id: "ryuuguu_no_shisha", ja: "竜宮の使者", image: "assets/enemies/ryuuguu_no_shisha.png", stage: "coast", hp: 48, atk: 11, def: 15, spd: 13, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "竜宮の穂先", mult: 1.2, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  oo_dako_2: { id: "oo_dako_2", ja: "大ダコ", image: "assets/enemies/oo_dako_2.png", stage: "coast", hp: 62, atk: 10, def: 15, spd: 7, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "岩場の抱擁", mult: 1.2, debuff: { type: "defDown", chance: 0.55, value: 0.25, turns: 3 } } },
  same_bito: { id: "same_bito", ja: "鮫人", image: "assets/enemies/same_bito.png", stage: "coast", hp: 54, atk: 12, def: 15, spd: 12, goldMin: 27, goldMax: 39, xp: 45, minFloor: 35, maxFloor: 67,
    bigAttack: { name: "鮫人の乱撃", mult: 1.25, debuff: { type: "bleed", chance: 0.6, value: 2 } },
    onHitInflict: { type: "bleed", chance: 0.25, value: 1 } },
  shinkai_no_bourei: { id: "shinkai_no_bourei", ja: "深海の亡霊", image: "assets/enemies/shinkai_no_bourei.png", stage: "coast", hp: 46, atk: 12, def: 15, spd: 10, goldMin: 26, goldMax: 38, xp: 44, minFloor: 35, maxFloor: 67,
  ...
  oo_kani_ou: { id: "oo_kani_ou", ja: "大蟹王", image: "assets/enemies/oo_kani_ou.png", stage: "coast", hp: 165, atk: 15, def: 35, spd: 7, goldMin: 90, goldMax: 130, xp: 150, minFloor: 38, maxFloor: 1498, isBoss: true,
    bigAttack: { name: "王鋏の一閃", mult: 1.5, debuff: { type: "defDown", chance: 0.4, value: 0.2, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  kaima_daiou: { id: "kaima_daiou", ja: "海魔大王", image: "assets/enemies/kaima_daiou.png", stage: "coast", hp: 95, atk: 17, def: 15, spd: 8, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "大槍薙ぎ", mult: 1.4, ignoreGuardian: true } },
  youen_na_isoonna: { id: "youen_na_isoonna", ja: "妖艶な磯女", image: "assets/enemies/youen_na_isoonna.png", stage: "coast", hp: 85, atk: 16, def: 15, spd: 11, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "魅了の歌声", mult: 1.1, debuff: { type: "atkDown", chance: 0.55, value: 0.25, turns: 3 } } },
  kyokai_no_oodako: { id: "kyokai_no_oodako", ja: "巨海の大ダコ", image: "assets/enemies/kyokai_no_oodako.png", stage: "coast", hp: 105, atk: 16, def: 15, spd: 7, goldMin: 48, goldMax: 68, xp: 87, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "八腕搦め", mult: 1.3, debuff: { type: "stun", chance: 0.35, turns: 1 } } },
  oni_harifugu: { id: "oni_harifugu", ja: "鬼ハリフグ", image: "assets/enemies/oni_harifugu.png", stage: "coast", hp: 88, atk: 16, def: 15, spd: 6, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
  ...
  oo_kani_shougun: { id: "oo_kani_shougun", ja: "大蟹将軍", image: "assets/enemies/oo_kani_shougun.png", stage: "coast", hp: 100, atk: 16, def: 15, spd: 6, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "将軍鋏", mult: 1.5, debuff: { type: "defDown", chance: 0.4, value: 0.25, turns: 3 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  kairyuu_ou: { id: "kairyuu_ou", ja: "海龍王", image: "assets/enemies/kairyuu_ou.png", stage: "coast", hp: 110, atk: 17, def: 15, spd: 10, goldMin: 50, goldMax: 70, xp: 90, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "海龍の雷", mult: 1.3, debuff: { type: "stun", chance: 0.4, turns: 1 } },
    onHitInflict: { type: "bleed", chance: 0.2, value: 2 } },
  same_no_bujin: { id: "same_no_bujin", ja: "鮫の武人", image: "assets/enemies/same_no_bujin.png", stage: "coast", hp: 92, atk: 17, def: 15, spd: 13, goldMin: 48, goldMax: 68, xp: 86, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "武人の穂先", mult: 1.3, debuff: { type: "bleed", chance: 0.65, value: 2 } },
    onHitInflict: { type: "bleed", chance: 0.3, value: 1 } },
  umi_no_souryo: { id: "umi_no_souryo", ja: "海の僧侶", image: "assets/enemies/umi_no_souryo.png", stage: "coast", hp: 85, atk: 15, def: 15, spd: 9, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "海僧の呪法", mult: 1.2, debuff: { type: "atkDown", chance: 0.5, value: 0.2, turns: 3 } },
    onHitInflict: { type: "poison", chance: 0.4, value: 3 } },
  uzushio_no_onryou: { id: "uzushio_no_onryou", ja: "渦潮の怨霊", image: "assets/enemies/uzushio_no_onryou.png", stage: "coast", hp: 90, atk: 16, def: 15, spd: 9, goldMin: 47, goldMax: 67, xp: 85, minFloor: 56, maxFloor: 1498,
    bigAttack: { name: "渦潮の引き寄せ", mult: 0.55, ignoreGuardian: true, debuff: { type: "stun", chance: 0.4, turns: 1 } } },
  kaiyoujo_ou: { id: "kaiyoujo_ou", ja: "海妖女王", image: "assets/enemies/kaiyoujo_ou.png", stage: "coast", hp: 300, atk: 21, def: 35, spd: 11, goldMin: 230, goldMax: 330, xp: 430, minFloor: 62, maxFloor: 1498, isBoss: true,
...
const EQUIPMENT = {
  samurai: {
    ...
    armor: [tier("当世具足", "def", 2, 30, 1), tier("強化当世具足", "def", 4, 20, 3), tier("上級当世具足", "def", 6, 30, 5), tier("鬼哭の甲冑", "def", 8, 45, 7), tier("伝説の甲冑", "def", 10, 55, 9)],
  },
  ninja: {
    weapon: [tier("業物の苦無", "atk", 2, 40, 1), tier("改良苦無", "atk", 4, 90, 3), tier("影の苦無", "atk", 5, 120, 5), tier("月影の苦無", "atk", 6, 160, 7), tier("暁の苦無", "atk", 7, 195, 9)],
    armor: [tier("強化忍び装束", "def", 2, 30, 1), tier("精鋭忍び装束", "def", 4, 20, 3), tier("上級忍び装束", "def", 6, 35, 5), tier("月影の装束", "def", 8, 45, 7), tier("暁の装束", "def", 10, 60, 9)],
  },
  spearman: {
    weapon: [tier("鍛えの槍", "atk", 2, 40, 1), tier("業物の槍", "atk", 3, 70, 3), tier("十文字槍", "atk", 4, 100, 5), tier("鬼殺しの槍", "atk", 5, 130, 7), tier("伝説の大槍", "atk", 6, 170, 9)],
    armor: [tier("鉄の大盾", "def", 2, 30, 1), tier("業物の大盾", "def", 4, 20, 3), tier("強化大盾", "def", 6, 35, 5), tier("鬼殺しの大盾", "def", 8, 45, 7), tier("伝説の盾", "def", 10, 60, 9)],
  },
  naginata: {
    weapon: [tier("鍛えの薙刀", "atk", 2, 40, 1), tier("業物の薙刀", "atk", 3, 65, 3), tier("大薙刀", "atk", 4, 90, 5), tier("巴形の薙刀", "atk", 5, 120, 7), tier("伝説の薙刀", "atk", 6, 155, 9)],
    armor: [tier("強化白鉢巻", "def", 2, 30, 1), tier("強化具足", "def", 4, 20, 3), tier("上級具足", "def", 6, 35, 5), tier("巴形の装束", "def", 8, 45, 7), tier("伝説の巫女装束", "def", 10, 65, 9)],
  },
  hunter: {
  ...
  onmyoji: {
    ...
    armor: [tier("浄衣", "def", 2, 30, 1), tier("精霊の浄衣", "def", 4, 10, 3), tier("上級浄衣", "def", 6, 20, 5), tier("秘伝の浄衣", "def", 8, 25, 7), tier("大陰陽の浄衣", "def", 10, 35, 9)],
  },
  priest: {
...
// ENEMY_DEF_SCALEは廃止(防御力を%直接方式に刷新したため、ENEMIES各体のdefが既に最終的な
// 被ダメ軽減%そのものであり、追加の倍率を掛ける必要がなくなった)
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    ENEMY_SCALE, SWARM_ENCOUNTER_CHANCE, BURN_DAMAGE_PCT,
