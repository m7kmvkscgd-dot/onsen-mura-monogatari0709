...
const ENEMIES = {
  yaken: { id: "yaken", ja: "野犬", image: "assets/enemies/yaken.png", hp: 48, atk: 12, def: 15, spd: 6, goldMin: 5, goldMax: 11, xp: 8, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "牙噛み", mult: 1, debuff: { type: "spdDown", chance: 0.45, value: 0.2, turns: 3 } } },
  inoshishi: { id: "inoshishi", ja: "猪", image: "assets/enemies/inoshishi.png", hp: 62, atk: 15, def: 15, spd: 4, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "猪突猛進", mult: 1.62 } },
  dokuhebi: { id: "dokuhebi", ja: "毒蛇", image: "assets/enemies/dokuhebi.png", hp: 44, atk: 15, def: 15, spd: 7, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "毒牙", mult: 0.9, debuff: { type: "poison", chance: 1, value: 3 } },
    onHitInflict: { type: "poison", chance: 0.5, value: 3 } },
  oogumo: { id: "oogumo", ja: "大蜘蛛", image: "assets/enemies/oogumo.png", hp: 58, atk: 15, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "糸搦め", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  kodama: { id: "kodama", ja: "木霊", image: "assets/enemies/kodama.png", hp: 51, atk: 15, def: 15, spd: 5, goldMin: 6, goldMax: 12, xp: 9, minFloor: 1, maxFloor: 18, isPlant: true,
    bigAttack: { name: "精気吸い", mult: 0.9, debuff: { type: "atkDown", chance: 0.5, value: 0.15, turns: 3 } } },
  kappa: { id: "kappa", ja: "河童", image: "assets/enemies/kappa.png", hp: 55, atk: 15, def: 15, spd: 6, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "河童相撲", mult: 1, debuff: { type: "defDown", chance: 0.5, value: 0.15, turns: 3 } } },
  hitotsume_kozo: { id: "hitotsume_kozo", ja: "一つ目小僧", image: "assets/enemies/hitotsume_kozo.png", hp: 48, atk: 15, def: 15, spd: 8, goldMin: 8, goldMax: 14, xp: 10, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "一つ目睨み", mult: 1, debuff: { type: "spdDown", chance: 0.4, value: 0.2, turns: 3 } } },
  bake_danuki: { id: "bake_danuki", ja: "化け狸", image: "assets/enemies/bake_danuki.png", hp: 62, atk: 15, def: 15, spd: 6, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "狸囃子", mult: 0.9, debuff: { type: "silence", chance: 0.45, turns: 2 } } },
  onibi: { id: "onibi", ja: "鬼火", image: "assets/enemies/onibi.png", hp: 41, atk: 15, def: 15, spd: 7, goldMin: 9, goldMax: 15, xp: 11, minFloor: 1, maxFloor: 18,
  ...
  kamaitachi: { id: "kamaitachi", ja: "かまいたち", image: "assets/enemies/kamaitachi.png", hp: 55, atk: 18, def: 15, spd: 10, goldMin: 11, goldMax: 18, xp: 13, minFloor: 1, maxFloor: 18,
    bigAttack: { name: "疾風斬", mult: 1, debuff: { type: "defDown", chance: 0.55, value: 0.2, turns: 3 } } },
  oo_inoshishi: { id: "oo_inoshishi", ja: "大猪", image: "assets/enemies/oo_inoshishi.png", hp: 431, atk: 24, def: 35, spd: 3, goldMin: 40, goldMax: 60, xp: 40, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "大猪突進", mult: 5.95 } },
  q_arakuma: { id: "q_arakuma", ja: "荒熊", image: "assets/enemies/q_arakuma.png", hp: 133, atk: 21, def: 35, spd: 3, goldMin: 35, goldMax: 55, xp: 42, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
  ...
  q_gashadokuro: { id: "q_gashadokuro", ja: "がしゃどくろ", image: "assets/enemies/q_gashadokuro.png", hp: 492, atk: 24, def: 35, spd: 8, goldMin: 38, goldMax: 58, xp: 45, minFloor: 1, maxFloor: 18, isBoss: true, questOnly: true, isMidBoss: true,
    bigAttack: { name: "骨鳴らし", mult: 1, debuff: { type: "stun", chance: 0.4, turns: 1 } } },
  ochimusha: { id: "ochimusha", ja: "落武者", image: "assets/enemies/ochimusha.png", hp: 116, atk: 21, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
    bigAttack: { name: "怨念の一閃", mult: 1.1, debuff: { type: "bleed", chance: 0.5, value: 2 } } },
  kamaitachi2: { id: "kamaitachi2", ja: "かまいたち", image: "assets/enemies/kamaitachi2.png", hp: 96, atk: 24, def: 15, spd: 12, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
  ...
  rokurokubi: { id: "rokurokubi", ja: "ろくろ首", image: "assets/enemies/rokurokubi.png", hp: 103, atk: 21, def: 15, spd: 8, goldMin: 18, goldMax: 29, xp: 24, minFloor: 13, maxFloor: 43,
  ...
  tsuchigumo: { id: "tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", hp: 109, atk: 21, def: 15, spd: 7, goldMin: 20, goldMax: 30, xp: 25, minFloor: 13, maxFloor: 43,
  ...
  oomukade: { id: "oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", hp: 130, atk: 24, def: 15, spd: 6, goldMin: 22, goldMax: 33, xp: 27, minFloor: 13, maxFloor: 43,
  ...
  cave_tsuchigumo: { id: "cave_tsuchigumo", ja: "土蜘蛛", image: "assets/enemies/tsuchigumo.png", stage: "cave", hp: 82, atk: 21, def: 15, spd: 7, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇網搦め", mult: 1.2, debuff: { type: "stun", chance: 0.45, turns: 1 } } },
  cave_oomukade: { id: "cave_oomukade", ja: "大百足", image: "assets/enemies/oomukade.png", stage: "cave", hp: 89, atk: 21, def: 15, spd: 6, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "百足の締め上げ", mult: 1.15, debuff: { type: "defDown", chance: 0.5, value: 0.2, turns: 3 } } },
  cave_oogumo: { id: "cave_oogumo", ja: "大蜘蛛", image: "assets/enemies/oogumo.png", stage: "cave", hp: 68, atk: 18, def: 15, spd: 7, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "闇の巣網", mult: 1.1, debuff: { type: "stun", chance: 0.5, turns: 1 } } },
  cave_nurarikoumori: { id: "cave_nurarikoumori", ja: "ぬらりこうもり", image: "assets/enemies/nurari_koumori.png", stage: "cave", hp: 30, atk: 13, def: 10, spd: 10, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isFlying: true, isSwarm: true,
    bigAttack: { name: "金切りの乱舞", mult: 0.85, debuff: { type: "spdDown", chance: 0.35, value: 0.15, turns: 2 } },
    onHitInflict: { type: "poison", chance: 0.4, value: 2, stacking: true } },
  cave_onibi: { id: "cave_onibi", ja: "鬼火", image: "assets/enemies/onibi.png", stage: "cave", hp: 55, atk: 18, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "纏わり火", mult: 1.1, debuff: { type: "burn", chance: 0.6, turnsMin: 2, turnsMax: 3 } },
    onHitInflict: { type: "burn", chance: 0.3, turnsMin: 2, turnsMax: 3 } },
  doukutsu_shokujinsou: { id: "doukutsu_shokujinsou", ja: "洞窟食人草", image: "assets/enemies/doukutsu_shokujinsou.png", stage: "cave", hp: 75, atk: 21, def: 15, spd: 4, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15, isPlant: true,
  ...
  doukutsu_chouchinbi: { id: "doukutsu_chouchinbi", ja: "洞窟の提灯火", image: "assets/enemies/doukutsu_chouchinbi.png", stage: "cave", hp: 62, atk: 18, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "提灯火の幻惑", mult: 1, debuff: { type: "silence", chance: 0.4, turns: 2 } } },
  bake_nezumi: { id: "bake_nezumi", ja: "化け鼠", image: "assets/enemies/bake_nezumi.png", stage: "cave", hp: 34, atk: 13, def: 10, spd: 9, goldMin: 4, goldMax: 7, xp: 6, minFloor: 1, maxFloor: 15, isSwarm: true,
    bigAttack: { name: "鼠の乱噛み", mult: 0.95, debuff: { type: "bleed", chance: 0.4, value: 2 } } },
  bake_take: { id: "bake_take", ja: "化け茸", image: "assets/enemies/bake_take.png", stage: "cave", hp: 68, atk: 18, def: 15, spd: 4, goldMin: 9, goldMax: 15, xp: 12, minFloor: 1, maxFloor: 15, isPlant: true,
  ...
  doukutsu_bourei: { id: "doukutsu_bourei", ja: "洞窟の亡霊", image: "assets/enemies/doukutsu_bourei.png", stage: "cave", hp: 62, atk: 21, def: 15, spd: 8, goldMin: 10, goldMax: 16, xp: 13, minFloor: 1, maxFloor: 15,
    bigAttack: { name: "亡霊の怨嗟", mult: 1.1, debuff: { type: "dmgTakenUp", chance: 0.45, value: 0.15, turns: 3 } } },
  doukutsu_inoshishi: { id: "doukutsu_inoshishi", ja: "洞窟イノシシ", image: "assets/enemies/doukutsu_inoshishi.png", stage: "cave", hp: 89, atk: 21, def: 15, spd: 4, goldMin: 10, goldMax: 17, xp: 13, minFloor: 1, maxFloor: 15,
