...
const DIALOGUE_LINES = {
  ...
  selfSkillHit: {
    優しい: ["やった！", "決まった！", "よかった。", "効いたね。"],
    熱血: ["決まった！", "どうだ！", "いいぞ！", "効いたか！"],
    冷静: ["決まった。", "想定どおり。", "効いている。", "終わりだ。"],
    生意気: ["どう？", "甘いね。", "いい感じ。", "この程度。"],
    のんびり: ["やったね。", "いい感じ。", "決まった。", "うまくいった。"],
    真面目: ["決まりました。", "効いています。", "成功です。", "この調子です。"],
    世話好き: ["よし。", "効いたね。", "大丈夫そう。", "うまくいった。"],
    お調子者: ["やったー！", "決まった！", "バッチリ！", "最高！"],
    無口: ["……決まった。", "……効いた。", "……よし。", "……終わり。"],
    豪快: ["どうだ！", "効いただろ！", "痛快だ！", "はっはっは！"],
  },
  allySkillHit: {
    優しい: ["いいね！", "やった！", "その調子！", "ナイス！"],
    熱血: ["よし！", "決まった！", "いいぞ！", "そのまま！"],
    冷静: ["決まったな。", "悪くない。", "効いてる。", "いい一撃だ。"],
    生意気: ["やるじゃん。", "いいね。", "さすが。", "悪くない。"],
    のんびり: ["おおー。", "やったね。", "いい感じ。", "いいねぇ。"],
    真面目: ["見事です。", "効いています。", "いい一撃です。", "この調子です。"],
    世話好き: ["よくやった！", "いいよ！", "その調子！", "助かった！"],
    お調子者: ["最高！", "ナイス！", "決まったー！", "やるね！"],
    無口: ["……いい。", "……決まった。", "……見事。", "……よし。"],
    豪快: ["いいぞ！", "痛快だ！", "その一撃だ！", "はっはっは！"],
  },
  selfHealed: {
  ...
  normalKill: {
    優しい: ["終わったね。", "よかった。", "一安心。", "次へ行こう。", "これで大丈夫。", "ほっとした。", "無事だね。", "片付いたね。"],
    熱血: ["倒した！", "次だ！", "よっしゃ！", "まだいくぞ！", "この調子！", "勝負はこれから！", "いいぞ！", "もっと来い！"],
    冷静: ["一体撃破。", "次へ。", "順調だ。", "問題ない。", "排除完了。", "想定どおり。", "油断するな。", "続行する。"],
    生意気: ["こんなもの？", "期待外れね。", "もう終わり？", "次、いこっか。", "あっけないね。", "その程度？", "退屈だな。", "まだ相手になる？"],
    のんびり: ["終わったね。", "なんとかなった。", "ほっとした。", "次いこっか。", "いい感じ。", "一人減ったね。", "よしよし。", "気が楽になった。"],
    真面目: ["一体撃破。", "次へ進みます。", "順調です。", "油断は禁物です。", "任務継続。", "確実にいきます。", "落ち着いて進もう。", "この調子です。"],
    世話好き: ["よし、一体。", "みんな大丈夫？", "この調子だね。", "次もいこう。", "ケガはない？", "任せて。", "よく頑張った。", "まだ気を抜かないで。"],
    お調子者: ["やったー！", "決まった！", "ナイス！", "いい感じ！", "楽勝！", "最高！", "次もいくよ！", "ノってきた！"],
    無口: ["……撃破。", "……次。", "……終わり。", "……よし。", "……片付いた。", "……問題ない。", "……続行。", "……行く。"],
    豪快: ["一丁上がり！", "次だ！", "軽い軽い！", "どんどん来い！", "はっはっは！", "他愛ない！", "まだ足りん！", "景気がいい！"],
  },
};
