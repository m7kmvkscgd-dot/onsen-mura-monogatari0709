...
const DUNGEON_EVENTS = [
  ...
  // 「化け狸の賭場」イベントは2026-08-01ユーザー指示で削除(賭け金モーダルtanukiBetOverlay=index.html、
  // showTanukiBetModal関数ごと撤去。画像assets/events/tanuki.pngのみ残置)
  {
...
// (化け狸の賭場showTanukiBetModalは2026-08-01ユーザー指示でイベントごと削除)
