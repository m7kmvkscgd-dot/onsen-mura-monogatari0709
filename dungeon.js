...
// 戦闘/財宝発見/茶屋/瀕死発見のいずれかが起きると暗転を挟んで一時停止し(時刻変化だけは例外で自動再開)、
...
const AUTO_RETREAT_CUT_FADE_MS = 400; // 財宝発見/時刻変化/茶屋/瀕死発見で一旦区切る時の暗転フェード時間
...
let lastFloorMoveOutcome = null; // rollEncounter()が"battle"/"gold"/"silent"/"kamikakushi"を記録する(オート帰還が結果を見て次の一時停止要否を判断するため)
