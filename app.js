...
function defaultState() {
  return {
    ...
    teaHouseLevel: 0, // 増築の1つ、茶屋のレベル(0=未建築、1=建築済み。家レベル7で解禁)。効果は未定(建物のみ)
    ...
    shrineLevel: 0, // 増築の1つ、神社のレベル(0=未建築、1=建築済み。家レベル5で解禁)。僧侶が雇えるようになり、おみくじを引けるようになる
...
function houseUpgradeCost(level) {
  return level === 1 ? 90 : 250; // レベル1→2は90G、以降(2→3以降)は一律250G
}
...
// 神社: 建築すると僧侶が雇えるようになり、出発画面でおみくじを引けるようになる
const SHRINE_UNLOCK_HOUSE_LEVEL = 5;
...
const ICONS = {
  ...
  // 状態異常
  poison: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M6.5 2h3M7 2v3.2L4.7 10.5A2.8 2.8 0 0 0 7.3 14.5h1.4a2.8 2.8 0 0 0 2.6-4L9 5.2V2"/></svg>',
  burn: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M8 1.8c1 2-1.2 2.6-1.2 4.4 0 .7.5 1.1.9 1.1s.7-.3.7-.8c0-.4-.2-.6-.2-.9 1.4.9 2.3 2.6 2.3 4.1A3.3 3.3 0 0 1 7 13.3 3.6 3.6 0 0 1 4.2 9.7c0-2.3 1.9-2.8 2.4-4.6.4-1.2.9-2 1.4-3.3Z"/></svg>',
  bleed: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M8 2c2.2 3 4 5.6 4 7.8A4 4 0 0 1 4 9.8C4 7.6 5.8 5 8 2Z"/><path d="M8 11.5v2" stroke-linecap="round"/></svg>',
  stun: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"><path d="M8 8c0-1.4 1.1-2.5 2.5-2.5S13 6.6 13 8s-1.3 2.5-2.8 2.5C8.3 10.5 7 9.1 7 7.5 7 4.5 9.5 2 12.5 2"/></svg>',
  silence: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"><path d="M3 4h8a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H8l-2.5 2V10H3a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z"/><path d="M2 2l12 12"/></svg>',
  tangle: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"><path d="M3 3l10 10M13 3L3 13M8 1v14M1 8h14"/></svg>',
  bigAttackPending: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"><path d="M8 2 14.5 13H1.5Z"/><path d="M8 6.3v3.4" stroke-linecap="round"/><circle cx="8" cy="11.3" r="0.55" fill="currentColor" stroke="none"/></svg>',
  guarding: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M8 2.2 13 4v4.3C13 11.5 10.8 13.2 8 14 5.2 13.2 3 11.5 3 8.3V4Z"/></svg>',
  carrying: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"><path d="M6 6a2 2 0 0 1 4 0" stroke-linecap="round"/><path d="M4.6 6h6.8l0.8 8H3.8Z"/></svg>',
  flying: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 9c2.5-3 5-4.5 7-4.5S12.5 6 15 9c-2.5 1.5-5 1-7-1.5-2 2.5-4.5 3-7 1.5Z"/></svg>',
  questTarget: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.2"><circle cx="8" cy="8" r="5"/><circle cx="8" cy="8" r="1.3" fill="currentColor" stroke="none"/><path d="M8 1.3v2.2M8 12.5v2.2M1.3 8h2.2M12.5 8h2.2" stroke-linecap="round"/></svg>',
  // 施設・行動(町画面等)
